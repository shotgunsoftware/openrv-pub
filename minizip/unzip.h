...
MINIZ_EXTERN int unzGetGlobalComment OF((unzFile file,
                                           char *szComment,
                                           uLong uSizeBuf));
/*
...
MINIZ_EXTERN int unzLocateFile OF((unzFile file,
...
MINIZ_EXTERN int unzGetFilePos(
    unzFile file,
    unz_file_pos* file_pos);

MINIZ_EXTERN int unzGoToFilePos(
    unzFile file,
    unz_file_pos* file_pos);

/* ****************************************** */

MINIZ_EXTERN int unzGetCurrentFileInfo OF((unzFile file,
...
MINIZ_EXTERN int unzOpenCurrentFile2 OF((unzFile file,
                                           int* method,
                                           int* level,
                                           int raw));
/*
...
MINIZ_EXTERN int unzOpenCurrentFile3 OF((unzFile file,
                                           int* method,
                                           int* level,
                                           int raw,
                                           const char* password));
...
MINIZ_EXTERN int unzReadCurrentFile OF((unzFile file,
                      voidp buf,
                      unsigned len));
/*
...
MINIZ_EXTERN int unzGetLocalExtrafield OF((unzFile file,
                                             voidp buf,
                                             unsigned len));
/*
