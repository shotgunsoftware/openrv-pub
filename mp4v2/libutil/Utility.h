...
namespace mp4v2
{
    namespace util
    {
        ...
        ///
        /// This class provides a base implementation for a general utility
        /// which helps meet behavioral criteria for command-line executables.
        ///
        /// Inherit batch processing ability is also provided and is used
        /// optionally by the concrete implementation.
        ///
        /// Criteria and guidelines for utility behavior in MP4v2 are as
        /// follows:
        ///     @li exit with 0 when the utility succeeds at its main task, 1
        ///     for failure.
        ///     @li print brief-usage when no arguments are supplied and exit
        ///     with 1.
        ///     @li print brief-usage when too many arguments are supplied and
        ///     exit with 1.
        ///     @li issue brief-usage when invalid argument is supplied and exit
        ///     with 1.
        ...
        ///         over-write an existing file unless given the project's
        ///         universal
        ...
        protected:
            ...
            {
            public:
                Option(char, bool, string, bool, uint32_t, string,
                       string = "ARG", string = "", bool = false);
            ...
            public:
                ...
                void add(const Option&); // options added this way will not be
                                         // deleted
                void add(char, bool, string, bool, uint32_t, string,
                         string = "ARG", string = "", bool = false);
                void add(string, bool, uint32_t, string, string = "ARG",
                         string = "", bool = false);
            ...
            public:
                ...
                MP4FileHandle
                    fileHandle; //!< handle of file, if applicable to job
                bool optimizeApplicable; //!< indicate file optimization is
                                         //!< applicable
        ...
        protected:
            ...
            void errf(const char*, ...)
                MP4V2_WFORMAT_PRINTF(2, 3); //!< print to stderr
            void outf(const char*, ...)
                MP4V2_WFORMAT_PRINTF(2, 3); //!< print to stdout

            bool herrf(const char*, ...)
                MP4V2_WFORMAT_PRINTF(2,
                                     3); //!< print to stderr indicating error
            bool hwarnf(const char*, ...)
                MP4V2_WFORMAT_PRINTF(2,
                                     3); //!< print to stderr indicating warning
            ...
            // delegates
            virtual bool
            utility_option(int, bool&) = 0; //!< process command-line option
            virtual bool
            utility_job(JobContext&) = 0; //!< process positional argument
        ...
        protected:
            // standard options for concrete utilities to add to _group in
            // constructor
