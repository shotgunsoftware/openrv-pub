...
namespace mp4v2
{
    namespace util
    {
        ...
        ///     @li lines of { <NAME><DELIMITER><VALUE><EOL> } form NAME/VALUEs
        ///     pairs.
        ...
        ///     @li <NAME> of value this._key marks the beginning of a new
        ///     record.
        ///     @li <NAME> is case-insensitive.
        ///     @li subsequent lines of NAME/VALUE pairs are part of the same
        ///     record.
        ///
        ///////////////////////////////////////////////////////////////////////////////
        class Database
        ...
        protected:
            ...
            /// Open database file.
            ///
            /// @param write <b>true</b> to open file for writing, <b>false</b>
            /// for reading.
            ...
            const string
                _filename;     // filename (basename only) used for database
