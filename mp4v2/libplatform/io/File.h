        ...
        namespace io
        {
            ...
            public:
                ...
                enum Mode
                {
                    ...
                    MODE_CREATE,    //!< file will be created/truncated for
                                    //!< read/write
                };
            ...
            public:
                ...
                virtual bool read(void* buffer, Size size, Size& nin,
                                  Size maxChunkSize) = 0;
                virtual bool write(const void* buffer, Size size, Size& nout,
                                   Size maxChunkSize) = 0;
            ...
            /// File implementation.
            ///
            /// File objects model real filesystem files in a 1:1 releationship
            /// and always treated as binary; there are no translations of text
            /// content performed.
            ///
            /// The interface represents all sizes with a signed 64-bit value,
            /// thus the limit to this interface is 63-bits of size,
            /// roughly 9.22 million TB.
            ///
            ///////////////////////////////////////////////////////////////////////////////
            ...
            public:
                ...
                //! @param provider a fileprovider instance. If NULL a standard
                //! file
                //!     provider will be used otherwise the supplied provider
                //!     must be new-allocated and will be delete'd via ~File().
                //!
                ///////////////////////////////////////////////////////////////////////////

                explicit File(std::string name = "", Mode mode = MODE_UNDEFINED,
                              FileProvider* = NULL);
                ...
                //! Destructor.
                //!
                //! File object is destroyed. If the file is opened it is closed
                ...
                //! Open file.
                //!
                //! @param name filename of file object, or empty-string to use
                //! #name.
                //!     On Windows, this should be a UTF-8 encoded string.
                //!     On other platforms, it should be an 8-bit encoding that
                //!     is appropriate for the platform, locale, file system,
                //!     etc. (prefer to use UTF-8 when possible).
                //!
                ...
                //! Binary stream read.
                //!
                //! The function reads up to a maximum <b>size</b> bytes from
                //! file, storing them in <b>buffer</b>. The number of bytes
                //! actually read are returned in <b>nin</b>.
                //!
                ...
                //! @param maxChunkSize maximum chunk size for reads issued to
                //! operating
                ...
                //! <b>buffer</b> to file. The number of bytes actually written
                //! are returned in <b>nout</b>.
                //!
                //! @param buffer data to be written out to file.
                //! @param size maximum number of bytes to read from file.
                //! @param nout output indicating number of bytes written to
                //! file.
                //! @param maxChunkSize maximum chunk size for writes issued to
                //! operating
                //!     system or 0 for default.
                //!
                //! @return true on failure, false on success.
            ...
            public:
                const std::string& name; //!< read-only: file pathname or
