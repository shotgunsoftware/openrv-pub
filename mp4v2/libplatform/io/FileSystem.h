...
namespace mp4v2
{
    namespace platform
    {
        namespace io
        {
            ...
            public:
                static string
                    DIR_SEPARATOR; //!< separator string used in file pathnames
                static string
                    PATH_SEPARATOR; //!< separator string used in search-paths
                ...
                //! Both <b>oldname</b> and <b>newname</b> must be of the same
                //! type; that is, both must be either files or directories and
                ...
                static void pathnameTemp(string& name, string dir = ".",
                                         string prefix = "tmp",
                                         string suffix = "");
                ...
                //! Cleanup pathname.
                //!
                //! Redundant (repeating) directory-separators are folded into a
...
TODO-KB: implement
    ...
    static void pathnameOnlyBasename( string& name );
                ...
                //!
                //! A pathname cleanup is always performed. See
                //! pathnameCleanup(). A file extension is considered to
                //! everything <b>after</b> the last '.' in the file component
                //! of a pathname. If no file extension exists then an
                ...
                //! pathnameCleanup(). A file extension is considered to
                //! everything <b>after</b> the last '.' in the file component
                //! of a pathname. The last '.' is also removed.
                //!
                //! @param name pathname to modify.
                //!
                ///////////////////////////////////////////////////////////////////////////
