...
namespace mp4v2
{
    namespace platform
    {
        namespace time
        {
            ...
            //!
            //! getLocalTimeMilliseconds obtains the system's notion of current
            //! Greenwich time, adjusted according to the current timezone of
            //! the host system. The time is expressed as an absolute value
            //! since midnight (0 hour), January 1, 1970. This is commonly
