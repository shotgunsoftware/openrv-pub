...
namespace mp4v2
{
    namespace impl
    {
        ...
        const itmf::EnumGenreType::Entry itmf::EnumGenreType::data[] = {
            ...
            {mp4v2::impl::itmf::GENRE_ALTERNATIVE, "alternative",
             "Alternative"},
            ...
            {mp4v2::impl::itmf::GENRE_INSTRUMENTAL, "instrumental",
             "Instrumental"},
            ...
            {mp4v2::impl::itmf::GENRE_INSTRUMENTAL_POP, "instrumentalpop",
             "Instrumental Pop"},
            {mp4v2::impl::itmf::GENRE_INSTRUMENTAL_ROCK, "instrumentalrock",
             "Instrumental Rock"},
            ...
            {mp4v2::impl::itmf::GENRE_TECHNO_INDUSTRIAL, "technoindustrial",
             "Techno-Industrial"},
            ...
            {mp4v2::impl::itmf::GENRE_SOUTHERN_ROCK, "southernrock",
             "Southern Rock"},
            ...
            {mp4v2::impl::itmf::GENRE_ROCK_AND_ROLL, "rockand_roll",
             "Rock & Roll"},
            ...
            {mp4v2::impl::itmf::GENRE_NATIONAL_FOLK, "nationalfolk",
             "National Folk"},
            ...
            {mp4v2::impl::itmf::GENRE_PROGRESSIVE_ROCK, "progressiverock",
             "Progresive Rock"},
            {mp4v2::impl::itmf::GENRE_PSYCHEDELIC_ROCK, "psychedelicrock",
             "Psychedelic Rock"},
            {mp4v2::impl::itmf::GENRE_SYMPHONIC_ROCK, "symphonicrock",
             "SYMPHONIC_ROCK"},
            ...
            {mp4v2::impl::itmf::GENRE_EASY_LISTENING, "easylistening",
             "Easy Listening"},
            ...
            {mp4v2::impl::itmf::GENRE_CHAMBER_MUSIC, "chambermusic",
             "Chamber Music"},
            ...
            {mp4v2::impl::itmf::GENRE_POWER_BALLAD, "powerballad",
             "Power Ballad"},
            {mp4v2::impl::itmf::GENRE_RHYTHMIC_SOUL, "rhythmicsoul",
             "Rhythmic Soul"},
        ...
        namespace itmf
        {
            ...
            BasicType computeBasicType(const void* buffer, uint32_t size)
            {
                ...
                for (ImageHeader* p = IMAGE_HEADERS; p->type != BT_UNDEFINED;
                     p++)
                {
                    ImageHeader& h = *p;
