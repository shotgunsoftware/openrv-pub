    ...
    namespace impl
    {
        namespace itmf
        {
            ...
            enum BasicType
            {
                ...
                BT_DATETIME = 17, ///< in UTC, counting seconds since midnight,
                                  ///< January 1, 1904; 32 or 64-bits
                BT_GENRES = 18,   ///< a list of enumerated values, see #Genre
                BT_INTEGER = 21,  ///< a signed big-endian integer with length
                                  ///< one of { 1,2,3,4,8 } bytes
                BT_RIAA_PA = 24,  ///< RIAA parental advisory; { -1=no, 1=yes,
                                  ///< 0=unspecified }, 8-bit ingteger
                BT_UPC = 25, ///< Universal Product Code, in text UTF-8 format
                             ///< (valid as an ID)
            ...
            /// enumerated genre as defined in ID3v1 specification but +1 as per
            /// iTMF spec. Note values 80 and higher are Winamp extensions.
            enum GenreType
            {
                GENRE_UNDEFINED = 0,
            ...
            MP4V2_EXPORT BasicType computeBasicType(const void* buffer,
                                                    uint32_t size);
