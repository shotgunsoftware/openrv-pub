    ...
    namespace impl
    {
        namespace itmf
        {
            ...
            public:
                ...
                void c_setTrack(const MP4TagTrack*, MP4TagTrack&,
                                const MP4TagTrack*&);
                void c_setDisk(const MP4TagDisk*, MP4TagDisk&,
                               const MP4TagDisk*&);
            ...
            private:
                void fetchString(const CodeItemMap&, const string&, string&,
                                 const char*&);
                void fetchInteger(const CodeItemMap&, const string&, uint8_t&,
                                  const uint8_t*&);
                void fetchInteger(const CodeItemMap&, const string&, uint16_t&,
                                  const uint16_t*&);
                void fetchInteger(const CodeItemMap&, const string&, uint32_t&,
                                  const uint32_t*&);
                void fetchInteger(const CodeItemMap&, const string&, uint64_t&,
                                  const uint64_t*&);

                void fetchGenre(const CodeItemMap&, uint16_t&,
                                const uint16_t*&);
                void fetchTrack(const CodeItemMap&, MP4TagTrack&,
                                const MP4TagTrack*&);
                void fetchDisk(const CodeItemMap&, MP4TagDisk&,
                               const MP4TagDisk*&);

                void storeString(MP4File&, const string&, const string&,
                                 const char*);
                void storeInteger(MP4File&, const string&, uint8_t,
                                  const uint8_t*);
                void storeInteger(MP4File&, const string&, uint16_t,
                                  const uint16_t*);
                void storeInteger(MP4File&, const string&, uint32_t,
                                  const uint32_t*);
                void storeInteger(MP4File&, const string&, uint64_t,
                                  const uint64_t*);

                void storeGenre(MP4File&, uint16_t, const uint16_t*);
                void storeTrack(MP4File&, const MP4TagTrack&,
                                const MP4TagTrack*);
                void storeDisk(MP4File&, const MP4TagDisk&, const MP4TagDisk*);

                void remove(MP4File&, const string&);
                void store(MP4File&, const string&, MP4ItmfBasicType,
                           const void*, uint32_t);
