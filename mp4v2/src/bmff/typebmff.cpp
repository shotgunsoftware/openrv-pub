...
namespace mp4v2
{
    namespace impl
    {
        ...
        const bmff::EnumLanguageCode::Entry bmff::EnumLanguageCode::data[] = {
            ...
            {mp4v2::impl::bmff::ILC_CPE, "cpe",
             "Creoles and pidgins, English based (Other)"},
            {mp4v2::impl::bmff::ILC_CPF, "cpf",
             "Creoles and pidgins, French-based (Other)"},
            {mp4v2::impl::bmff::ILC_CPP, "cpp",
             "Creoles and pidgins, Portuguese-based (Other)"},
            {mp4v2::impl::bmff::ILC_CRE, "cre", "Cree"},
            {mp4v2::impl::bmff::ILC_CRH, "crh",
            ...
            {mp4v2::impl::bmff::ILC_GMH, "gmh",
             "German, Middle High (ca.1050-1500)"},
            {mp4v2::impl::bmff::ILC_GOH, "goh",
            ...
            {mp4v2::impl::bmff::ILC_NBL, "nbl",
             "Ndebele, South; South Ndebele"},
            {mp4v2::impl::bmff::ILC_NDE, "nde",
             "Ndebele, North; North Ndebele"},
            {mp4v2::impl::bmff::ILC_NDO, "ndo", "Ndonga"},
            {mp4v2::impl::bmff::ILC_NDS, "nds",
            ...
            {mp4v2::impl::bmff::ILC_NNO, "nno",
             "Norwegian Nynorsk; Nynorsk, Norwegian"},
            {mp4v2::impl::bmff::ILC_NOB, "nob",
            ...
            {mp4v2::impl::bmff::ILC_ZXX, "zxx",
             "No linguistic content; Not applicable"},
            {mp4v2::impl::bmff::ILC_ZZA, "zza",
