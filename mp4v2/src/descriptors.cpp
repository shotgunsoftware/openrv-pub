...
namespace mp4v2
{
    namespace impl
    {
        ...
        MP4BaseDescriptor::MP4BaseDescriptor(MP4Atom& parentAtom, uint8_t tag)
            : MP4Descriptor(parentAtom, tag)
        {
            ...
            case MP4SupplContentIdDescrTag:
                AddProperty(/* 0 */
                            new MP4BytesProperty(parentAtom, "languageCode",
                                                 3));
                AddProperty(/* 1 */
                            new MP4StringProperty(parentAtom, "title",
                                                  Counted));
                AddProperty(/* 2 */
                            new MP4StringProperty(parentAtom, "value",
                                                  Counted));
                break;
            case MP4IPMPPtrDescrTag:
                AddProperty(/* 0 */
                            new MP4Integer8Property(parentAtom,
                                                    "IPMPDescriptorId"));
                break;
            case MP4ExtProfileLevelDescrTag:
                AddProperty(/* 0 */
                            new MP4Integer8Property(
                                parentAtom, "profileLevelIndicationIndex"));
                AddProperty(/* 1 */
                            new MP4Integer8Property(
                                parentAtom, "ODProfileLevelIndication"));
                AddProperty(/* 2 */
                            new MP4Integer8Property(
                                parentAtom, "sceneProfileLevelIndication"));
                AddProperty(/* 3 */
                            new MP4Integer8Property(
                                parentAtom, "audioProfileLevelIndication"));
                AddProperty(/* 4 */
                            new MP4Integer8Property(
                                parentAtom, "visualProfileLevelIndication"));
                AddProperty(/* 5 */
                            new MP4Integer8Property(
                                parentAtom, "graphicsProfileLevelIndication"));
                AddProperty(/* 6 */
                            new MP4Integer8Property(
                                parentAtom, "MPEGJProfileLevelIndication"));
                break;
            default:
                log.errorf("%s: \"%s\": error in base descriptor - tag %u",
                           __FUNCTION__,
        ...
        MP4BytesDescriptor::MP4BytesDescriptor(MP4Atom& parentAtom, uint8_t tag)
            : MP4Descriptor(parentAtom, tag)
        {
            m_size_offset = 0;
            m_bytes_index = 0;
            ...
            else
            {
                ...
                case MP4IPMPDescrTag:
                    AddProperty(/* 0 */
                                new MP4Integer8Property(parentAtom,
                                                        "IPMPDescriptorId"));
                    AddProperty(/* 1 */
                                new MP4Integer16Property(parentAtom,
                                                         "IPMPSType"));
                    AddProperty(/* 2 */
                ...
                case MP4RegistrationDescrTag:
                    ...
                    break;
                default:
                    log.errorf("%s: \"%s\": error in bytes descriptor - tag %u",
                               __FUNCTION__,
        ...
        void MP4BytesDescriptor::Read(MP4File& file)
        {
            ...
            ((MP4BytesProperty*)m_pProperties[m_bytes_index])
                ->SetValueSize(m_size - m_size_offset);
            ...
            : MP4Descriptor(parentAtom, MP4FileIODescrTag)
        {
            ...
            AddProperty(/* 2 */
                        new MP4BitfieldProperty(
                            parentAtom, "includeInlineProfileLevelFlag", 1));
            AddProperty(/* 3 */
            ...
            AddProperty(/* 8 */
                        new MP4Integer8Property(parentAtom,
                                                "visualProfileLevelId"));
            AddProperty(/* 9 */
                        new MP4Integer8Property(parentAtom,
                                                "graphicsProfileLevelId"));
            AddProperty(/* 10 */
                        new MP4DescriptorProperty(parentAtom, "esIds",
                                                  MP4ESIDIncDescrTag, 0,
                                                  Required, Many));
            AddProperty(/* 11 */
                        new MP4DescriptorProperty(
                            parentAtom, "ociDescr", MP4OCIDescrTagsStart,
                            MP4OCIDescrTagsEnd, Optional, Many));
            AddProperty(/* 12 */
                        new MP4DescriptorProperty(parentAtom, "ipmpDescrPtr",
                                                  MP4IPMPPtrDescrTag, 0,
                                                  Optional, Many));
            AddProperty(/* 13 */
                        new MP4DescriptorProperty(
                            parentAtom, "extDescr", MP4ExtDescrTagsStart,
                            MP4ExtDescrTagsEnd, Optional, Many));
            ...
            : MP4Descriptor(parentAtom, MP4ESDescrTag)
        {
            ...
            AddProperty(/* 2 */
                        new MP4BitfieldProperty(parentAtom, "URLFlag", 1));
            AddProperty(/* 3 */
                        new MP4BitfieldProperty(parentAtom, "OCRstreamFlag",
                                                1));
            AddProperty(/* 4 */
                        new MP4BitfieldProperty(parentAtom, "streamPriority",
                                                5));
            AddProperty(/* 5 */
            ...
            AddProperty(/* 11 */
                        new MP4DescriptorProperty(
                            parentAtom, "ipIds", MP4ContentIdDescrTag,
                            MP4SupplContentIdDescrTag, Optional, Many));
            AddProperty(/* 12 */
                        new MP4DescriptorProperty(parentAtom, "ipmpDescrPtr",
                                                  MP4IPMPPtrDescrTag, 0,
                                                  Optional, Many));
        ...
        void MP4ESDescriptor::Mutate()
        {
            ...
            bool urlFlag = ((MP4BitfieldProperty*)m_pProperties[2])->GetValue();
            m_pProperties[6]->SetImplicit(!urlFlag);

            bool ocrFlag = ((MP4BitfieldProperty*)m_pProperties[3])->GetValue();
            ...
            : MP4Descriptor(parentAtom, MP4DecConfigDescrTag)
        {
            ...
            AddProperty(/* 4 */
                        new MP4BitfieldProperty(parentAtom, "bufferSizeDB",
                                                24));
            AddProperty(/* 5 */
            ...
            AddProperty(/* 7 */
                        new MP4DescriptorProperty(parentAtom, "decSpecificInfo",
                                                  MP4DecSpecificDescrTag, 0,
                                                  Optional, OnlyOne));
            AddProperty(/* 8 */
                        new MP4DescriptorProperty(
                            parentAtom, "profileLevelIndicationIndexDescr",
            ...
            : MP4Descriptor(parentAtom, MP4SLConfigDescrTag)
        {
            ...
            AddProperty(/* 4 */
                        new MP4BitfieldProperty(
                            parentAtom, "hasRandomAccessUnitsOnlyFlag", 1));
            AddProperty(/* 5 */
                        new MP4BitfieldProperty(parentAtom, "usePaddingFlag",
                                                1));
            AddProperty(/* 6 */
                        new MP4BitfieldProperty(parentAtom, "useTimeStampsFlag",
                                                1));
            AddProperty(/* 7 */
            ...
            AddProperty(/* 15 */
                        new MP4BitfieldProperty(parentAtom,
                                                "degradationPriortyLength", 4));
            AddProperty(/* 16 */
                        new MP4BitfieldProperty(parentAtom, "AUSeqNumLength",
                                                5));
            AddProperty(/* 17 */
                        new MP4BitfieldProperty(parentAtom,
                                                "packetSeqNumLength", 5));
            AddProperty(/* 18 */
            ...
            AddProperty(/* 22 */
                        new MP4BitfieldProperty(parentAtom,
                                                "startDecodingTimeStamp", 64));
            AddProperty(/* 23 */
                        new MP4BitfieldProperty(
                            parentAtom, "startCompositionTimeStamp", 64));
        }
        ...
        void MP4SLConfigDescriptor::Mutate()
        {
            ...
            for (i = 22; i <= 23; i++)
            {
                ...
                ((MP4BitfieldProperty*)m_pProperties[i])
                    ->SetNumBits(timeStampLength);
        ...
        {
            AddProperty(/* 0 */
                        new MP4BitfieldProperty(parentAtom, "compatibility",
                                                2));
            AddProperty(/* 1 */
                        new MP4BitfieldProperty(parentAtom, "contentTypeFlag",
                                                1));
            AddProperty(/* 2 */
                        new MP4BitfieldProperty(parentAtom, "contentIdFlag",
                                                1));
            AddProperty(/* 3 */
                        new MP4BitfieldProperty(parentAtom, "protectedContent",
                                                1));
            AddProperty(/* 4 */
        ...
        MP4Descriptor*
        MP4DescriptorProperty::CreateDescriptor(MP4Atom& parentAtom,
                                                uint8_t tag)
        {
            ...
            case MP4QosDescrTag:
                pDescriptor =
                    new MP4QosDescriptorBase(parentAtom, MP4QosDescrTag);
                break;
            case MP4IODescrTag:
