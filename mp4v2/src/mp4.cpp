...
static MP4File* ConstructMP4File(void)
{
    ...
    {
        mp4v2::impl::log.errorf("%s: unknown exception constructing MP4File",
                                __FUNCTION__);
    }
...
extern "C"
{
    ...
    MP4FileHandle MP4CreateEx(const char* fileName, uint32_t flags,
                              int add_ftyp, int add_iods, char* majorBrand,
                              ...
                              uint32_t supportedBrandsCount)
    {
        ...
        try
        {
            ...
            pFile->Create(fileName, flags, add_ftyp, add_iods, majorBrand,
                          minorVersion, supportedBrands, supportedBrandsCount);
            return (MP4FileHandle)pFile;
        }
        catch (Exception* x)
        {
    ...
    MP4FileHandle MP4Modify(const char* fileName, uint32_t flags)
    {
        if (!fileName)
            return MP4_INVALID_FILE_HANDLE;
    ...
    bool MP4Optimize(const char* fileName, const char* newFileName)
    {
        ...
        {
            mp4v2::impl::log.errorf("%s(%s,%s) failed", __FUNCTION__, fileName,
                                    newFileName);
        }
    ...
    bool MP4Dump(MP4FileHandle hFile, bool dumpImplicits)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
            try
    ...
    uint8_t MP4GetVideoProfileLevel(MP4FileHandle hFile, MP4TrackId trackId)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
            try
            ...
            if (MP4_IS_VALID_TRACK_ID(trackId))
            {
                ...
                {
                    if (MP4GetTrackESConfiguration(hFile, trackId, &foo,
                                                   &bufsize))
                    {
                        uint8_t* ptr = foo;
                        while (bufsize > 0)
    ...
    bool MP4GetIntegerProperty(MP4FileHandle hFile, const char* propName,
                               uint64_t* retvalue)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
    ...
    bool MP4GetFloatProperty(MP4FileHandle hFile, const char* propName,
                             float* retvalue)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
    ...
    bool MP4GetStringProperty(MP4FileHandle hFile, const char* propName,
                              const char** retvalue)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
    ...
    bool MP4GetBytesProperty(MP4FileHandle hFile, const char* propName,
                             uint8_t** ppValue, uint32_t* pValueSize)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
            ...
            {
                ((MP4File*)hFile)
                    ->GetBytesProperty(propName, ppValue, pValueSize);
                return true;
            }
            catch (Exception* x)
            {
    ...
    bool MP4SetIntegerProperty(MP4FileHandle hFile, const char* propName,
                               int64_t value)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
    ...
    bool MP4SetFloatProperty(MP4FileHandle hFile, const char* propName,
                             float value)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
    ...
    bool MP4SetStringProperty(MP4FileHandle hFile, const char* propName,
                              const char* value)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
    ...
    bool MP4SetBytesProperty(MP4FileHandle hFile, const char* propName,
                             const uint8_t* pValue, uint32_t valueSize)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
            ...
            {
                ((MP4File*)hFile)
                    ->SetBytesProperty(propName, pValue, valueSize);
                return true;
            }
            catch (Exception* x)
            {
    ...
    MP4TrackId MP4AddULawAudioTrack(MP4FileHandle hFile, uint32_t timeScale)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
            try
            {
                return ((MP4File*)hFile)->AddULawAudioTrack(timeScale);
            }
            catch (Exception* x)
            {
                mp4v2::impl::log.errorf(*x);
    ...
    MP4TrackId MP4AddALawAudioTrack(MP4FileHandle hFile, uint32_t timeScale)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
            try
            {
                return ((MP4File*)hFile)->AddALawAudioTrack(timeScale);
            }
            catch (Exception* x)
            {
                mp4v2::impl::log.errorf(*x);
    ...
    mp4v2_ismacrypParams* MP4DefaultISMACrypParams(mp4v2_ismacrypParams* ptr)
    {
        try
        {
            if (ptr == NULL)
            {
                ptr = (mp4v2_ismacrypParams*)MP4Malloc(
                    sizeof(mp4v2_ismacrypParams));
            }
                                   ...
                                   uint8_t bit_rate_code)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
            ...
            {
                return ((MP4File*)hFile)
                    ->AddAC3AudioTrack(samplingRate, fscod, bsid, bsmod, acmod,
                                       lfeon, bit_rate_code);
            }
            catch (Exception* x)
            {
    ...
    MP4TrackId MP4AddEncAudioTrack(MP4FileHandle hFile, uint32_t timeScale,
        ...
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
            try
            {
                ...
                else
                {
                    return ((MP4File*)hFile)
                        ->AddEncAudioTrack(
                            timeScale, sampleDuration, audioType,
                                   ...
                                   uint8_t framesPerSample, bool isAmrWB)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
            ...
            {
                return ((MP4File*)hFile)
                    ->AddAmrAudioTrack(timeScale, modeSet, modeChangePeriod,
                                       framesPerSample, isAmrWB);
            }
            catch (Exception* x)
            {
                mp4v2::impl::log.errorf(*x);
                         ...
                         uint32_t vendor)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
            try
            {
                ((MP4File*)hFile)->SetAmrVendor(trackId, vendor);
            }
            catch (Exception* x)
            {
                mp4v2::impl::log.errorf(*x);
    ...
    void MP4SetAmrModeSet(MP4FileHandle hFile, MP4TrackId trackId,
                          uint16_t modeSet)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
    ...
    MP4TrackId MP4AddHrefTrack(MP4FileHandle hFile, uint32_t timeScale,
                               MP4Duration sampleDuration, const char* base_url)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
            try
            {
                ...
                return pFile->AddHrefTrack(timeScale, sampleDuration, base_url);
            }
            catch (Exception* x)
            {
                mp4v2::impl::log.errorf(*x);
    ...
    const char* MP4GetHrefTrackBaseUrl(MP4FileHandle hFile, MP4TrackId trackId)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
            ...
            {
                return ((MP4File*)hFile)
                    ->GetTrackStringProperty(
                        trackId, "mdia.minf.stbl.stsd.href.burl.base_url");
            }
            catch (Exception* x)
            {
                mp4v2::impl::log.errorf(*x);
    ...
    MP4TrackId MP4AddVideoTrack(MP4FileHandle hFile, uint32_t timeScale,
                                ...
                                uint16_t height, uint8_t videoType)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
            try
            {
                ...
                return pFile->AddMP4VideoTrack(timeScale, sampleDuration, width,
                                               height, videoType);
            }
            catch (Exception* x)
            {
    ...
    MP4TrackId MP4AddEncVideoTrack(MP4FileHandle hFile, uint32_t timeScale,
                                   MP4Duration sampleDuration, uint16_t width,
                                   uint16_t height, mp4v2_ismacrypParams* icPp,
                                   uint8_t videoType, const char* oFormat)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
            try
            {
                ...
                return pFile->AddEncVideoTrack(timeScale, sampleDuration, width,
                                               height, videoType, icPp,
                                               oFormat);
            }
            catch (Exception* x)
            {
    ...
    MP4TrackId MP4AddColr(MP4FileHandle hFile, MP4TrackId refTrackId,
                          uint16_t pri, uint16_t tran, uint16_t mat)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
            try
                                    ...
                                    uint8_t sampleLenFieldSizeMinusOne)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
            try
            {
                ...
                return pFile->AddH264VideoTrack(
    ...
    MP4TrackId MP4AddEncH264VideoTrack(MP4FileHandle hFile, uint32_t timeScale,
                                       MP4Duration sampleDuration,
...

    {
        ...
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
            try
            {
                ...
                srcAtom = pFile->FindTrackAtom(srcTrackId,
                ...
                return pFile->AddEncH264VideoTrack(
                    timeScale, sampleDuration, width, height, srcAtom, icPp);
            }
            catch (Exception* x)
            {
                mp4v2::impl::log.errorf(*x);
                                        ...
                                        uint16_t sequenceLen)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
            try
            {
                ...
                pFile->AddH264SequenceParameterSet(trackId, pSequence,
                                                   sequenceLen);
                return;
            }
            catch (Exception* x)
                                    ...
                                    uint32_t maxBitrate)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
            ...
            {
                return ((MP4File*)hFile)
                    ->AddH263VideoTrack(timeScale, sampleDuration, width,
                                        height, h263Level, h263Profile,
                          ...
                          uint32_t vendor)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
            try
            {
                ((MP4File*)hFile)->SetH263Vendor(trackId, vendor);
            }
            catch (Exception* x)
            {
                mp4v2::impl::log.errorf(*x);
                                   ...
                                   uint16_t width, uint16_t height)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
            ...
            {
                return ((MP4File*)hFile)
                    ->AddSubtitleTrack(timescale, width, height);
            }
            catch (Exception* x)
            {
                mp4v2::impl::log.errorf(*x);
                                 ...
                                 uint16_t width, uint16_t height)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
            ...
            {
                return ((MP4File*)hFile)
                    ->AddSubpicTrack(timescale, width, height);
            }
            catch (Exception* x)
            {
                mp4v2::impl::log.errorf(*x);
    ...
    MP4TrackId MP4AddChapterTextTrack(MP4FileHandle hFile,
                                      MP4TrackId refTrackId, uint32_t timescale)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
            try
            {
                return ((MP4File*)hFile)
                    ->AddChapterTextTrack(refTrackId, timescale);
            }
            catch (Exception* x)
            {
                mp4v2::impl::log.errorf(*x);
    ...
    MP4TrackId MP4AddPixelAspectRatio(MP4FileHandle hFile,
                                      MP4TrackId refTrackId, uint32_t hSpacing,
                                      uint32_t vSpacing)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
            ...
            {
                return ((MP4File*)hFile)
                    ->AddPixelAspectRatio(refTrackId, hSpacing, vSpacing);
            }
            catch (Exception* x)
            {
                mp4v2::impl::log.errorf(*x);
    ...
    void MP4AddChapter(MP4FileHandle hFile, MP4TrackId chapterTrackId,
                       MP4Duration chapterDuration, const char* chapterTitle)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
            try
            {
                ((MP4File*)hFile)
                    ->AddChapter(chapterTrackId, chapterDuration, chapterTitle);
            }
            catch (Exception* x)
            {
                mp4v2::impl::log.errorf(*x);
                                     ...
                                     MP4TrackId chapterTrackId)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
            ...
            {
                return ((MP4File*)hFile)
                    ->DeleteChapters(fromChapterType, chapterTrackId);
            }
            catch (Exception* x)
            {
                mp4v2::impl::log.errorf(*x);
                                  ...
                                  MP4ChapterType fromChapterType)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
            ...
            {
                return ((MP4File*)hFile)
                    ->GetChapters(chapterList, chapterCount, fromChapterType);
            }
            catch (Exception* x)
            {
                mp4v2::impl::log.errorf(*x);
                                  ...
                                  MP4ChapterType toChapterType)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
            ...
            {
                return ((MP4File*)hFile)
                    ->SetChapters(chapterList, chapterCount, toChapterType);
            }
            catch (Exception* x)
            {
                mp4v2::impl::log.errorf(*x);
                             ...
                             MP4TrackId dstHintTrackReferenceTrack)
    {
        ...
        if (MP4_IS_VIDEO_TRACK_TYPE(trackType))
        {
            if (ATOMID(media_data_name) == ATOMID("mp4v"))
            {
                ...
                dstTrackId = MP4AddVideoTrack(
                    dstFile, MP4GetTrackTimeScale(srcFile, srcTrackId),
            ...
            else if (ATOMID(media_data_name) == ATOMID("avc1"))
            {
                ...
                uint32_t ix;
                MP4GetTrackH264SeqPictHeaders(srcFile, srcTrackId, &seqheader,
                                              &seqheadersize, &pictheader,
                                              &pictheadersize);
                for (ix = 0; seqheadersize[ix] != 0; ix++)
                {
                    MP4AddH264SequenceParameterSet(
                        dstFile, dstTrackId, seqheader[ix], seqheadersize[ix]);
                    free(seqheader[ix]);
                }
                free(seqheader);
                free(seqheadersize);
        ...
        else if (MP4_IS_HINT_TRACK_TYPE(trackType))
        {
            ...
            {
                dstTrackId =
                    MP4AddHintTrack(dstFile, dstHintTrackReferenceTrack);
            }
        }
            ...
            || MP4_IS_VIDEO_TRACK_TYPE(trackType))
        {
            ...
            bool haveEs = MP4GetTrackESConfiguration(srcFile, srcTrackId,
                                                     &pConfig, &configSize);
            mp4v2::impl::log.setVerbosity(verb);
            if (haveEs && pConfig != NULL && configSize != 0)
            {
                if (!MP4SetTrackESConfiguration(dstFile, dstTrackId, pConfig,
                                                configSize))
                {
                    free(pConfig);
        ...
        if (MP4_IS_HINT_TRACK_TYPE(trackType))
        {
            ...
            if (MP4GetHintTrackRtpPayload(srcFile, srcTrackId, &payloadName,
                                          &payloadNumber, &maxPayloadSize,
                                          &encodingParms))
            {

                if (MP4SetHintTrackRtpPayload(dstFile, dstTrackId, payloadName,
                                              &payloadNumber, maxPayloadSize,
                                              encodingParms)
                    == false)
                {
    ...
    MP4TrackId MP4EncAndCloneTrack(MP4FileHandle srcFile, MP4TrackId srcTrackId,
                                   mp4v2_ismacrypParams* icPp,
                                   MP4FileHandle dstFile,
                                   MP4TrackId dstHintTrackReferenceTrack)
    {
        ...
        if (MP4_IS_VIDEO_TRACK_TYPE(trackType))
        {
            ...
            {
                dstTrackId = MP4AddEncH264VideoTrack(
                    dstFile, MP4GetTrackTimeScale(srcFile, srcTrackId),
                    MP4GetTrackFixedSampleDuration(srcFile, srcTrackId),
                    MP4GetTrackVideoWidth(srcFile, srcTrackId),
                    MP4GetTrackVideoHeight(srcFile, srcTrackId), srcFile,
                    srcTrackId, icPp);
            }
            else
            {
                MP4SetVideoProfileLevel(dstFile,
                                        MP4GetVideoProfileLevel(srcFile));
                dstTrackId = MP4AddEncVideoTrack(
                    dstFile, MP4GetTrackTimeScale(srcFile, srcTrackId),
                    MP4GetTrackFixedSampleDuration(srcFile, srcTrackId),
                    MP4GetTrackVideoWidth(srcFile, srcTrackId),
                    MP4GetTrackVideoHeight(srcFile, srcTrackId), icPp,
                    MP4GetTrackEsdsObjectTypeId(srcFile, srcTrackId), oFormat);
            }
        }
        else if (MP4_IS_AUDIO_TRACK_TYPE(trackType))
        {
            MP4SetAudioProfileLevel(dstFile, MP4GetAudioProfileLevel(srcFile));
            dstTrackId = MP4AddEncAudioTrack(
                dstFile, MP4GetTrackTimeScale(srcFile, srcTrackId),
                MP4GetTrackFixedSampleDuration(srcFile, srcTrackId), icPp,
                MP4GetTrackEsdsObjectTypeId(srcFile, srcTrackId));
        }
        else if (MP4_IS_OD_TRACK_TYPE(trackType))
        {
            ...
            || MP4_IS_VIDEO_TRACK_TYPE(trackType))
        {
            ...
            uint8_t* pConfig = NULL;
            uint32_t configSize = 0;
            if (MP4GetTrackESConfiguration(srcFile, srcTrackId, &pConfig,
                                           &configSize))
            {

                if (pConfig != NULL)
                {
                    MP4SetTrackESConfiguration(dstFile, dstTrackId, pConfig,
                                               configSize);
                }
            }
            if (pConfig != NULL)
        ...
        if (MP4_IS_HINT_TRACK_TYPE(trackType))
        {
                                          ...
                                          &encodingParms))
            {
                ...
                (void)MP4SetHintTrackRtpPayload(dstFile, dstTrackId,
                                                payloadName, &payloadNumber,
                                                maxPayloadSize, encodingParms);
            }
#if 0
            MP4SetHintTrackSdp(
                dstFile,
    ...
    MP4TrackId MP4CopyTrack(MP4FileHandle srcFile, MP4TrackId srcTrackId,
                            MP4FileHandle dstFile, bool applyEdits,
                            MP4TrackId dstHintTrackReferenceTrack)
    {
        bool copySamples = true; // LATER allow false => reference samples

        MP4TrackId dstTrackId = MP4CloneTrack(srcFile, srcTrackId, dstFile,
        ...
        while (true)
        {
            ...
            if (viaEdits)
            {
                sampleId = MP4GetSampleIdFromEditTime(srcFile, srcTrackId, when,
                                                      NULL, &sampleDuration);
            ...
            if (copySamples)
            {
                rc = MP4CopySample(srcFile, srcTrackId, sampleId, dstFile,
                                   dstTrackId, sampleDuration);
            }
            else
            {
                rc = MP4ReferenceSample(srcFile, srcTrackId, sampleId, dstFile,
                                        dstTrackId, sampleDuration);
            }
    ...
    MP4TrackId MP4EncAndCopyTrack(MP4FileHandle srcFile, MP4TrackId srcTrackId,
                                  mp4v2_ismacrypParams* icPp,
                                  encryptFunc_t encfcnp, uint32_t encfcnparam1,
                                  MP4FileHandle dstFile, bool applyEdits,
                                  MP4TrackId dstHintTrackReferenceTrack)
    {
        bool copySamples = true; // LATER allow false => reference samples

        MP4TrackId dstTrackId = MP4EncAndCloneTrack(
            srcFile, srcTrackId, icPp, dstFile, dstHintTrackReferenceTrack);
        ...
        while (true)
        {
            ...
            {
                // encrypt and copy
                rc = MP4EncAndCopySample(srcFile, srcTrackId, sampleId, encfcnp,
                                         encfcnparam1, dstFile, dstTrackId,
                                         sampleDuration);
            }
            else
            {
                                            ...
                                            uint32_t buflen)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
            try
            {
                ...
                return ((MP4File*)hFile)
                    ->GetTrackMediaDataOriginalFormat(trackId, originalFormat,
                                                      buflen);
            }
            catch (Exception* x)
            {
    ...
    uint32_t MP4GetTrackBitRate(MP4FileHandle hFile, MP4TrackId trackId)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
            ...
            try
            {
                return pFile->GetTrackIntegerProperty(
                    trackId,
                    "mdia.minf.stbl.stsd.*.esds.decConfigDescr.avgBitrate");
            }
            catch (Exception* x)
            {
                // mp4v2::impl::log.errorf(*x);  we don't really need to print
                // this.
                delete x;
            }
            catch (...)
            ...
            try
            {
                ...
                uint64_t msDuration = pFile->ConvertFromTrackDuration(
                    trackId, trackDur, MP4_MSECS_TIME_SCALE);
                if (msDuration == 0)
                    return 0;
                                    ...
                                    uint8_t** ppConfig, uint32_t* pConfigSize)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
            ...
            {
                ((MP4File*)hFile)
                    ->GetTrackESConfiguration(trackId, ppConfig, pConfigSize);
                return true;
            }
            catch (Exception* x)
            {
                                  ...
                                  uint8_t** ppConfig, uint32_t* pConfigSize)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
            ...
            {
                ((MP4File*)hFile)
                    ->GetTrackVideoMetadata(trackId, ppConfig, pConfigSize);
                return true;
            }
            catch (Exception* x)
            {
                                    ...
                                    const uint8_t* pConfig, uint32_t configSize)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
            ...
            {
                ((MP4File*)hFile)
                    ->SetTrackESConfiguration(trackId, pConfig, configSize);
                return true;
            }
            catch (Exception* x)
            {
                                     ...
                                     uint8_t* pProfile, uint8_t* pLevel)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
            try
            {
                *pProfile = ((MP4File*)hFile)
                                ->GetTrackIntegerProperty(
                                    trackId, "mdia.minf.stbl.stsd.*[0].avcC."
                                             "AVCProfileIndication");
                *pLevel =
                    ((MP4File*)hFile)
                        ->GetTrackIntegerProperty(
                                       ...
                                       uint32_t** pPictHeaderSize)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
            ...
            {
                ((MP4File*)hFile)
                    ->GetTrackH264SeqPictHeaders(trackId, pSeqHeader,
                                                 pSeqHeaderSize, pPictHeader,
                                                 pPictHeaderSize);
                return true;
            }
            catch (Exception* x)
    ...
    // returns true if the track is a media track encrypted according to
    // ismacryp
                          ...
                          const char* atomName)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
            try
            {
                return ((MP4File*)hFile)->FindTrackAtom(trackId, atomName)
                       != NULL;
            }
            catch (Exception* x)
            {
                                    ...
                                    const char* propName, uint64_t* retvalue)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
            try
            {
                *retvalue = ((MP4File*)hFile)
                                ->GetTrackIntegerProperty(trackId, propName);
                return true;
            }
            catch (Exception* x)
            {
    ...
    bool MP4GetTrackFloatProperty(MP4FileHandle hFile, MP4TrackId trackId,
                                  const char* propName, float* retvalue)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
            try
            {
                *retvalue =
                    ((MP4File*)hFile)->GetTrackFloatProperty(trackId, propName);
                return true;
            }
            catch (Exception* x)
            {
                                   ...
                                   const char* propName, const char** retvalue)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
            ...
            {
                *retvalue = ((MP4File*)hFile)
                                ->GetTrackStringProperty(trackId, propName);
                return true;
            }
            catch (Exception* x)
            {
                                  ...
                                  uint32_t* pValueSize)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
            ...
            {
                ((MP4File*)hFile)
                    ->GetTrackBytesProperty(trackId, propName, ppValue,
                                            pValueSize);
                return true;
            }
            catch (Exception* x)
                                    ...
                                    const char* propName, int64_t value)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
            ...
            {
                ((MP4File*)hFile)
                    ->SetTrackIntegerProperty(trackId, propName, value);
                return true;
            }
            catch (Exception* x)
            {
                                  ...
                                  const char* propName, float value)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
            ...
            {
                ((MP4File*)hFile)
                    ->SetTrackFloatProperty(trackId, propName, value);
                return true;
            }
            catch (Exception* x)
            {
                                   ...
                                   const char* propName, const char* value)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
            ...
            {
                ((MP4File*)hFile)
                    ->SetTrackStringProperty(trackId, propName, value);
                return true;
            }
            catch (Exception* x)
            {
                                  ...
                                  uint32_t valueSize)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
            ...
            {
                ((MP4File*)hFile)
                    ->SetTrackBytesProperty(trackId, propName, pValue,
                                            valueSize);
                return true;
            }
            catch (Exception* x)
    ...
    bool MP4ReadSample(
        ...
        /* output parameters */
        uint8_t** ppBytes, uint32_t* pNumBytes, MP4Timestamp* pStartTime,
        MP4Duration* pDuration, MP4Duration* pRenderingOffset,
        bool* pIsSyncSample)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
            ...
            {
                ((MP4File*)hFile)
                    ->ReadSample(trackId, sampleId, ppBytes, pNumBytes,
                                 pStartTime, pDuration, pRenderingOffset,
                                 pIsSyncSample);
                return true;
            }
            catch (Exception* x)
    ...
    bool MP4ReadSampleFromTime(
        /* input parameters */
        MP4FileHandle hFile, MP4TrackId trackId, MP4Timestamp when,
        /* output parameters */
        uint8_t** ppBytes, uint32_t* pNumBytes, MP4Timestamp* pStartTime,
        MP4Duration* pDuration, MP4Duration* pRenderingOffset,
        bool* pIsSyncSample)
        ...
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
            try
            {
                MP4SampleId sampleId =
                    ((MP4File*)hFile)
                        ->GetSampleIdFromTime(trackId, when, false);
                        ...
                        bool isSyncSample)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
            ...
            {
                ((MP4File*)hFile)
                    ->WriteSample(trackId, pBytes, numBytes, duration,
    ...
    bool MP4WriteSampleDependency(MP4FileHandle hFile, MP4TrackId trackId,
                                  const uint8_t* pBytes, uint32_t numBytes,
                                  ...
                                  bool isSyncSample, uint32_t dependencyFlags)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
            ...
            {
                ((MP4File*)hFile)
                    ->WriteSampleDependency(trackId, pBytes, numBytes, duration,
                                            renderingOffset, isSyncSample,
                                            dependencyFlags);
                return true;
            }
    ...
    bool MP4CopySample(MP4FileHandle srcFile, MP4TrackId srcTrackId,
                       MP4SampleId srcSampleId, MP4FileHandle dstFile,
                       MP4TrackId dstTrackId, MP4Duration dstSampleDuration)
    {
        ...
        try
        {
            MP4File::CopySample((MP4File*)srcFile, srcTrackId, srcSampleId,
                                (MP4File*)dstFile, dstTrackId,
                                dstSampleDuration);
            return true;
        }
        catch (Exception* x)
    ...
    bool MP4EncAndCopySample(MP4FileHandle srcFile, MP4TrackId srcTrackId,
                             MP4SampleId srcSampleId, encryptFunc_t encfcnp,
                             uint32_t encfcnparam1, MP4FileHandle dstFile,
                             ...
                             MP4Duration dstSampleDuration)
    {
        ...
        try
        {
            MP4File::EncAndCopySample(
                (MP4File*)srcFile, srcTrackId, srcSampleId, encfcnp,
                encfcnparam1, (MP4File*)dstFile, dstTrackId, dstSampleDuration);
            return true;
        }
        catch (Exception* x)
        {
    ...
    bool MP4ReferenceSample(MP4FileHandle srcFile, MP4TrackId srcTrackId,
                            MP4SampleId srcSampleId, MP4FileHandle dstFile,
                            MP4TrackId dstTrackId,
                            MP4Duration dstSampleDuration)
    {
    ...
    uint32_t MP4GetSampleSize(MP4FileHandle hFile, MP4TrackId trackId,
                              MP4SampleId sampleId)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
    ...
    MP4SampleId MP4GetSampleIdFromTime(MP4FileHandle hFile, MP4TrackId trackId,
                                       MP4Timestamp when, bool wantSyncSample)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
            ...
            {
                return ((MP4File*)hFile)
                    ->GetSampleIdFromTime(trackId, when, wantSyncSample);
            }
            catch (Exception* x)
            {
                mp4v2::impl::log.errorf(*x);
    ...
    MP4Timestamp MP4GetSampleTime(MP4FileHandle hFile, MP4TrackId trackId,
                                  MP4SampleId sampleId)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
    ...
    MP4Duration MP4GetSampleDuration(MP4FileHandle hFile, MP4TrackId trackId,
                                     MP4SampleId sampleId)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
                                            ...
                                            MP4SampleId sampleId)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
            ...
            {
                return ((MP4File*)hFile)
                    ->GetSampleRenderingOffset(trackId, sampleId);
            }
            catch (Exception* x)
            {
                mp4v2::impl::log.errorf(*x);
    ...
    bool MP4SetSampleRenderingOffset(MP4FileHandle hFile, MP4TrackId trackId,
                                     MP4SampleId sampleId,
                                     MP4Duration renderingOffset)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
            ...
            {
                ((MP4File*)hFile)
                    ->SetSampleRenderingOffset(trackId, sampleId,
                                               renderingOffset);
                return true;
            }
            catch (Exception* x)
    ...
    int8_t MP4GetSampleSync(MP4FileHandle hFile, MP4TrackId trackId,
                            MP4SampleId sampleId)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
    ...
    uint64_t MP4ConvertFromMovieDuration(MP4FileHandle hFile,
                                         MP4Duration duration,
                                         uint32_t timeScale)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
            ...
            {
                return ((MP4File*)hFile)
                    ->ConvertFromMovieDuration(duration, timeScale);
            }
            catch (Exception* x)
            {
                mp4v2::impl::log.errorf(*x);
    ...
    uint64_t MP4ConvertFromTrackTimestamp(MP4FileHandle hFile,
                                          MP4TrackId trackId,
                                          ...
                                          uint32_t timeScale)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
            ...
            {
                return ((MP4File*)hFile)
                    ->ConvertFromTrackTimestamp(trackId, timeStamp, timeScale);
            }
            catch (Exception* x)
            {
                mp4v2::impl::log.errorf(*x);
    ...
    MP4Timestamp MP4ConvertToTrackTimestamp(MP4FileHandle hFile,
                                            MP4TrackId trackId,
                                            uint64_t timeStamp,
                                            uint32_t timeScale)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
            ...
            {
                return ((MP4File*)hFile)
                    ->ConvertToTrackTimestamp(trackId, timeStamp, timeScale);
            }
            catch (Exception* x)
            {
                mp4v2::impl::log.errorf(*x);
    ...
    uint64_t MP4ConvertFromTrackDuration(MP4FileHandle hFile,
                                         MP4TrackId trackId,
                                         MP4Duration duration,
                                         uint32_t timeScale)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
            ...
            {
                return ((MP4File*)hFile)
                    ->ConvertFromTrackDuration(trackId, duration, timeScale);
            }
            catch (Exception* x)
            {
                mp4v2::impl::log.errorf(*x);
    ...
    MP4Duration MP4ConvertToTrackDuration(MP4FileHandle hFile,
                                          MP4TrackId trackId, uint64_t duration,
                                          uint32_t timeScale)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
            ...
            {
                return ((MP4File*)hFile)
                    ->ConvertToTrackDuration(trackId, duration, timeScale);
            }
            catch (Exception* x)
            {
                mp4v2::impl::log.errorf(*x);
    ...
    bool MP4GetHintTrackRtpPayload(MP4FileHandle hFile, MP4TrackId hintTrackId,
                                   char** ppPayloadName,
                                   ...
                                   char** ppEncodingParams)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
            ...
            {
                ((MP4File*)hFile)
                    ->GetHintTrackRtpPayload(hintTrackId, ppPayloadName,
                                             pPayloadNumber, pMaxPayloadSize,
                                             ppEncodingParams);
                return true;
            }
            catch (Exception* x)
    ...
    bool MP4SetHintTrackRtpPayload(MP4FileHandle hFile, MP4TrackId hintTrackId,
                                   ...
                                   bool include_mpeg4_esid)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
            ...
            {
                ((MP4File*)hFile)
                    ->SetHintTrackRtpPayload(hintTrackId, pPayloadName,
                                             pPayloadNumber, maxPayloadSize,
                                             encode_params, include_rtp_map,
                                             include_mpeg4_esid);
                return true;
            }
            catch (Exception* x)
    ...
    bool MP4SetHintTrackSdp(MP4FileHandle hFile, MP4TrackId hintTrackId,
    ...
    bool MP4AppendHintTrackSdp(MP4FileHandle hFile, MP4TrackId hintTrackId,
                               const char* sdpString)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
    ...
    bool MP4ReadRtpHint(MP4FileHandle hFile, MP4TrackId hintTrackId,
                        MP4SampleId hintSampleId, uint16_t* pNumPackets)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
            try
            {
                ((MP4File*)hFile)
                    ->ReadRtpHint(hintTrackId, hintSampleId, pNumPackets);
                return true;
            }
            catch (Exception* x)
            {
                                          ...
                                          MP4TrackId hintTrackId)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
            ...
            {
                return ((MP4File*)hFile)
                    ->GetRtpHintNumberOfPackets(hintTrackId);
            }
            catch (Exception* x)
            {
                mp4v2::impl::log.errorf(*x);
    ...
    int8_t MP4GetRtpPacketBFrame(MP4FileHandle hFile, MP4TrackId hintTrackId,
    ...
    bool MP4ReadRtpPacket(MP4FileHandle hFile, MP4TrackId hintTrackId,
                          ...
                          bool includeHeader, bool includePayload)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
            ...
            {
                ((MP4File*)hFile)
                    ->ReadRtpPacket(hintTrackId, packetIndex, ppBytes,
                                    pNumBytes, ssrc, includeHeader,
                                    includePayload);
                return true;
            }
            catch (Exception* x)
    ...
    bool MP4SetRtpTimestampStart(MP4FileHandle hFile, MP4TrackId hintTrackId,
                                 MP4Timestamp rtpStart)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
            try
            {
                ((MP4File*)hFile)->SetRtpTimestampStart(hintTrackId, rtpStart);
                return true;
            }
            catch (Exception* x)
            {
    ...
    bool MP4AddRtpVideoHint(MP4FileHandle hFile, MP4TrackId hintTrackId,
                            bool isBframe, uint32_t timestampOffset)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
            ...
            {
                ((MP4File*)hFile)
                    ->AddRtpHint(hintTrackId, isBframe, timestampOffset);
                return true;
            }
            catch (Exception* x)
            {
    ...
    bool MP4AddRtpPacket(MP4FileHandle hFile, MP4TrackId hintTrackId,
                         bool setMbit, int32_t transmitOffset)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
            try
            {
                ((MP4File*)hFile)
                    ->AddRtpPacket(hintTrackId, setMbit, transmitOffset);
                return true;
            }
            catch (Exception* x)
            {
                                ...
                                const uint8_t* pBytes, uint32_t numBytes)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
            ...
            {
                ((MP4File*)hFile)
                    ->AddRtpImmediateData(hintTrackId, pBytes, numBytes);
                return true;
            }
            catch (Exception* x)
            {
    ...
    bool MP4AddRtpSampleData(MP4FileHandle hFile, MP4TrackId hintTrackId,
                             MP4SampleId sampleId, uint32_t dataOffset,
                             uint32_t dataLength)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
            ...
            {
                ((MP4File*)hFile)
                    ->AddRtpSampleData(hintTrackId, sampleId, dataOffset,
                                       dataLength);
                return true;
            }
            catch (Exception* x)
                         ...
                         MP4Duration duration, bool isSyncSample)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
            ...
            {
                ((MP4File*)hFile)
                    ->WriteRtpHint(hintTrackId, duration, isSyncSample);
                return true;
            }
            catch (Exception* x)
            {
    ...
    bool MP4Make3GPCompliant(const char* fileName, char* majorBrand,
                             uint32_t minorVersion, char** supportedBrands,
                             uint32_t supportedBrandsCount, bool deleteIodsAtom)
    {
        if (!fileName)
            return false;
        ...
        try
        {
            ...
            pFile->Make3GPCompliant(fileName, majorBrand, minorVersion,
    ...
    bool MP4MakeIsmaCompliant(const char* fileName, bool addIsmaComplianceSdp)
    {
        if (!fileName)
            return false;
    ...
    char* MP4MakeIsmaSdpIod(uint8_t videoProfile, uint32_t videoBitrate,
                            uint8_t* videoConfig, uint32_t videoConfigLength,
                            uint8_t audioProfile, uint32_t audioBitrate,
                            uint8_t* audioConfig, uint32_t audioConfigLength)

    {
        ...
        try
        {
            ...
            pFile->CreateIsmaIodFromParams(
                videoProfile, videoBitrate, videoConfig, videoConfigLength,
                audioProfile, audioBitrate, audioConfig, audioConfigLength,
                &pBytes, &numBytes);

            char* iodBase64 = MP4ToBase64(pBytes, numBytes);
            MP4Free(pBytes);

            char* sdpIod = (char*)MP4Malloc(strlen(iodBase64) + 64);
            snprintf(
                sdpIod, strlen(iodBase64) + 64,
    ...
    MP4EditId MP4AddTrackEdit(MP4FileHandle hFile, MP4TrackId trackId,
                              MP4EditId editId, MP4Timestamp startTime,
                              MP4Duration duration, bool dwell)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
            try
            {
                ...
                {
                    ((MP4File*)hFile)
                        ->SetTrackEditMediaStart(trackId, newEditId, startTime);
                    ((MP4File*)hFile)
                        ->SetTrackEditDuration(trackId, newEditId, duration);
                    ((MP4File*)hFile)
                        ->SetTrackEditDwell(trackId, newEditId, dwell);
                }
    ...
    bool MP4DeleteTrackEdit(MP4FileHandle hFile, MP4TrackId trackId,
                            MP4EditId editId)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
    ...
    MP4Timestamp MP4GetTrackEditMediaStart(MP4FileHandle hFile,
                                           MP4TrackId trackId, MP4EditId editId)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
            try
            {
                return ((MP4File*)hFile)
                    ->GetTrackEditMediaStart(trackId, editId);
            }
            catch (Exception* x)
            {
                mp4v2::impl::log.errorf(*x);
    ...
    MP4Duration MP4GetTrackEditTotalDuration(MP4FileHandle hFile,
                                             MP4TrackId trackId,
                                             MP4EditId editId)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
            ...
            {
                return ((MP4File*)hFile)
                    ->GetTrackEditTotalDuration(trackId, editId);
            }
            catch (Exception* x)
            {
                mp4v2::impl::log.errorf(*x);
    ...
    bool MP4SetTrackEditMediaStart(MP4FileHandle hFile, MP4TrackId trackId,
                                   MP4EditId editId, MP4Timestamp startTime)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
            ...
            {
                ((MP4File*)hFile)
                    ->SetTrackEditMediaStart(trackId, editId, startTime);
                return true;
            }
            catch (Exception* x)
            {
    ...
    MP4Duration MP4GetTrackEditDuration(MP4FileHandle hFile, MP4TrackId trackId,
                                        MP4EditId editId)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
    ...
    bool MP4SetTrackEditDuration(MP4FileHandle hFile, MP4TrackId trackId,
                                 MP4EditId editId, MP4Duration duration)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
            try
            {
                ((MP4File*)hFile)
                    ->SetTrackEditDuration(trackId, editId, duration);
                return true;
            }
            catch (Exception* x)
            {
    ...
    int8_t MP4GetTrackEditDwell(MP4FileHandle hFile, MP4TrackId trackId,
                                MP4EditId editId)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
    ...
    bool MP4SetTrackEditDwell(MP4FileHandle hFile, MP4TrackId trackId,
                              MP4EditId editId, bool dwell)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
            try
    ...
    bool MP4ReadSampleFromEditTime(
        ...
        bool* pIsSyncSample)
    {
        MP4SampleId sampleId = MP4GetSampleIdFromEditTime(
            hFile, trackId, when, pStartTime, pDuration);

        return MP4ReadSample(hFile, trackId, sampleId, ppBytes, pNumBytes, NULL,
                             NULL, pRenderingOffset, pIsSyncSample);
    }

    MP4SampleId MP4GetSampleIdFromEditTime(MP4FileHandle hFile,
                                           MP4TrackId trackId,
                                           MP4Timestamp when,
                                           ...
                                           MP4Duration* pDuration)
    {
        if (MP4_IS_VALID_FILE_HANDLE(hFile))
        {
            ...
            {
                return ((MP4File*)hFile)
                    ->GetSampleIdFromEditTime(trackId, when, pStartTime,
                                              pDuration);
            }
            catch (Exception* x)
            {
    ...
    bool MP4AddIPodUUID(MP4FileHandle hFile, MP4TrackId trackId)
    {
        ...
        try
        {
            ...
            ASSERT(track);
            avc1 =
                track->GetTrakAtom().FindChildAtom("mdia.minf.stbl.stsd.avc1");
        }
        catch (Exception* x)
        {
            mp4v2::impl::log.errorf(*x);
        ...
        catch (...)
        {
            mp4v2::impl::log.errorf(
                "%s: unknown exception constructing IPodUUIDAtom",
                __FUNCTION__);
            return false;
        }
    ...
    bool MP4GetTrackLanguage(MP4FileHandle hFile, MP4TrackId trackId,
                             char* code)
    {
        if (!MP4_IS_VALID_FILE_HANDLE(hFile))
            return false;
    ...
    bool MP4SetTrackName(MP4FileHandle hFile, MP4TrackId trackId,
                         const char* code)
    {
        if (!MP4_IS_VALID_FILE_HANDLE(hFile))
            return false;
