    ...
    namespace impl
    {
            ...
            : MP4Descriptor(parentAtom)
        {
            ...
            AddProperty(/* 1 */
                        new MP4Integer16Property(parentAtom,
                                                 "classificationTable"));
            AddProperty(/* 2 */
                        new MP4BytesProperty(parentAtom,
            ...
            : MP4Descriptor(parentAtom)
        {
            ...
            MP4TableProperty* pTable =
                new MP4TableProperty(parentAtom, "keywords", pCount);
            AddProperty(pTable); /* 4 */

            pTable->AddProperty(/* 4, 0 */
                                new MP4StringProperty(pTable->GetParentAtom(),
                                                      "string", Counted));
            ...
            : MP4Descriptor(parentAtom)
        {
            ...
            AddProperty(/* 2 */
                        new MP4BitfieldProperty(parentAtom, "reserved", 7));
            AddProperty(/* 3 */
                        new MP4StringProperty(parentAtom, "eventName",
                                              Counted));
            AddProperty(/* 4 */
                        new MP4StringProperty(parentAtom, "eventText",
                                              Counted));
            ...
            : MP4Descriptor(parentAtom)
        {
            ...
            MP4TableProperty* pTable =
                new MP4TableProperty(parentAtom, "items", pCount);
            AddProperty(pTable); /* 4 */
        ...
        {
        public:
            MP4CreatorTableProperty(MP4Atom& parentAtom, const char* name,
                                    MP4Integer8Property* pCountProperty)
        ...
        private:
            ...
            MP4CreatorTableProperty&
            operator=(const MP4CreatorTableProperty& src);
        };

        MP4CreatorDescriptor::MP4CreatorDescriptor(MP4Atom& parentAtom,
                                                   uint8_t tag)
            : MP4Descriptor(parentAtom, tag)
        {
            ...
            MP4TableProperty* pTable =
                new MP4CreatorTableProperty(parentAtom, "creators", pCount);
            AddProperty(pTable); /* 1 */

            pTable->AddProperty(/* Table 0 */
                                new MP4BytesProperty(pTable->GetParentAtom(),
                                                     "languageCode", 3, 3));
            pTable->AddProperty(/* Table 1 */
        ...
        void MP4CreatorTableProperty::ReadEntry(MP4File& file, uint32_t index)
        {
            ...
            bool utf8Flag =
                ((MP4BitfieldProperty*)m_pProperties[1])->GetValue(index);
            ((MP4StringProperty*)m_pProperties[3])->SetUnicode(!utf8Flag);
        ...
        MP4CreationDescriptor::MP4CreationDescriptor(MP4Atom& parentAtom,
                                                     uint8_t tag)
            : MP4Descriptor(parentAtom, tag)
        {
            AddProperty(/* 0 */
                        new MP4BitfieldProperty(parentAtom,
                                                "contentCreationDate", 40));
        }
            ...
            : MP4Descriptor(parentAtom)
        {
            ...
            MP4TableProperty* pTable =
                new MP4TableProperty(parentAtom, "parameters", pCount);
            AddProperty(pTable);

            pTable->AddProperty(new MP4Integer8Property(parentAtom, "id"));
            pTable->AddProperty(new MP4Integer32Property(parentAtom, "value"));
        }
