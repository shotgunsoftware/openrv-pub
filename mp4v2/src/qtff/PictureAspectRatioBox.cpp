    ...
    namespace impl
    {
        namespace qtff
        {
            ...
            namespace
            {
                ...
                bool findPictureAspectRatioBox(MP4FileHandle file,
                                               MP4Atom& coding, MP4Atom*& pasp);
            } // namespace

            ///////////////////////////////////////////////////////////////////////////////

            bool PictureAspectRatioBox::add(MP4FileHandle file,
                                            uint16_t trackIndex,
                                            const Item& item)
            {
                MP4Atom* coding;
                ...
                if (!findPictureAspectRatioBox(file, *coding, pasp))
                    throw new Exception("pasp-box already exists", __FILE__,
                                        __LINE__, __FUNCTION__);

                pasp = MP4Atom::CreateAtom(*((MP4File*)file), coding,
                                           BOX_CODE.c_str());
                ...
                if (pasp->FindProperty("pasp.hSpacing",
                                       (MP4Property**)&hSpacing))
                    hSpacing->SetValue(item.hSpacing);

                if (pasp->FindProperty("pasp.vSpacing",
                                       (MP4Property**)&vSpacing))
            ...
            bool PictureAspectRatioBox::get(MP4FileHandle file,
                                            uint16_t trackIndex, Item& item)
            {
                item.reset();
                ...
                MP4Atom* pasp;
                if (findPictureAspectRatioBox(file, *coding, pasp))
                    throw new Exception("pasp-box not found", __FILE__,
                                        __LINE__, __FUNCTION__);
            ...
            bool PictureAspectRatioBox::list(MP4FileHandle file,
                                             ItemList& itemList)
            {
                itemList.clear();
                MP4File& mp4 = *((MP4File*)file);
            ...
            bool PictureAspectRatioBox::remove(MP4FileHandle file,
                                               uint16_t trackIndex)
            {
                MP4Atom* coding;
                if (findCoding(file, trackIndex, coding))
            ...
            bool PictureAspectRatioBox::set(MP4FileHandle file,
                                            uint16_t trackIndex,
                                            const Item& item)
            {
                MP4Atom* coding;
            ...
            void PictureAspectRatioBox::Item::reset()
            {
                hSpacing = 1;
                vSpacing = 1;
            }
            ...
            void PictureAspectRatioBox::Item::convertFromCSV(const string& text)
            {
            ...
            string PictureAspectRatioBox::Item::convertToCSV() const
            {
                string buffer;
