...
namespace mp4v2
{
    namespace impl
    {
        namespace qtff
        {
            ...
            ///
            /// A colr-box is expected to be contained in a video track which is
            ...
            public:
                ...
                /// This object correlates to one colr-box (Color Parameter
                /// Box).
                ///
                ...
                public:
                    ...
                    /// Specifies an index into a table specifying the CIE 1931
                    /// xy chromaticity coordinates of the white point and the
                    /// red, green, and blue primaries. The table of primaries
                    /// specifies the white point and the red, green, and blue
                    /// primary color points for a video system.
                    uint16_t primariesIndex;

                    /// a 16-bit unsigned integer index.
                    /// Specifies an an index into a table specifying the
                    /// nonlinear transfer function coefficients used to
                    /// translate between RGB color space values and Y′CbCr
                    /// values. The table of transfer function coefficients
                    /// specifies the nonlinear function coefficients used to
                    /// translate between the stored Y′CbCr values and a video
                    /// capture or display system.
                    uint16_t transferFunctionIndex;

                    /// a 16-bit unsigned integer index.
                    /// Specifies an index into a table specifying the
                    /// transformation matrix coefficients used to translate
                    /// between RGB color space values and Y′CbCr values. The
                    /// table of matrixes specifies the matrix used during the
                    /// translation.
                ...
                ///
                /// This function adds a colr-box to <b>trackId</b> of
                ...
                /// Store colr-box (Color Parameter Box) properties by
                /// track-index.
                ///
                ...
                /// Fetch colr-box (Color Parameter Box) properties by
                /// track-index.
                ///
