...
namespace mp4v2
{
    namespace impl
    {
        ...
        MP4StandardAtom::MP4StandardAtom(MP4File& file, const char* type)
            : MP4Atom(file, type)
        {
            /*
            ...
            {
                AddProperty(
                    new MP4Integer32Property(*this, "bufferSizeDB")); /* 0 */
                AddProperty(
                    new MP4Integer32Property(*this, "avgBitrate")); /* 1 */
                AddProperty(
                    new MP4Integer32Property(*this, "maxBitrate")); /* 2 */
            }
            ...
            else if (ATOMID(type) == ATOMID("ctts"))
            {
                ...
                pTable->AddProperty(new MP4Integer32Property(
                    pTable->GetParentAtom(), "sampleCount"));
                pTable->AddProperty(new MP4Integer32Property(
                    pTable->GetParentAtom(), "sampleOffset"));
                /*
                 * d???
                 */
            }
            ...
            {
                AddVersionAndFlags();
                AddProperty(new MP4DescriptorProperty(
                    *this, NULL, MP4ESDescrTag, 0, Required, OnlyOne));
                /*
                 * f???
                 */
            }
            ...
            else if (ATOMID(type) == ATOMID("hmhd"))
            {
                ...
                AddProperty(
                    new MP4Integer32Property(*this, "slidingAvgBitRate"));
                /*
                 * i???
                 */
            }
            else if (ATOMID(type) == ATOMID("iKMS"))
            {
                ...
                MP4StringProperty* pProp =
                    new MP4StringProperty(*this, "kms_URI");
                AddProperty(pProp); /* 2 */
            }
            ...
            else if (ATOMID(type) == ATOMID("ilst"))
            {
                ...
                ExpectChildAtom("\251gen", Optional,
                                OnlyOne);                   /* custom genre */
                ExpectChildAtom("trkn", Optional, OnlyOne); /* tracknumber */
                ExpectChildAtom("disk", Optional, OnlyOne); /* disknumber */
                ExpectChildAtom("gnre", Optional,
                                OnlyOne); /* genre (ID3v1 index + 1) */
                ...
                ExpectChildAtom("keyw", Optional,
                                OnlyOne); /* Keywords (for podcasts?) */
                ExpectChildAtom("catg", Optional,
                                OnlyOne); /* Category (for podcasts?) */
                ExpectChildAtom("purl", Optional, OnlyOne); /* Podcast URL */
                ExpectChildAtom("egid", Optional,
                                OnlyOne); /* Podcast episode global unique ID */
                ...
                ExpectChildAtom("akID", Optional,
                                OnlyOne); /* iTunes Account Type */
            ...
            else if (ATOMID(type) == ATOMID("imif"))
            {
                AddVersionAndFlags();
                AddProperty(new MP4DescriptorProperty(
                    *this, "ipmp_desc", MP4IPMPDescrTag, MP4IPMPDescrTag,
                    Required, Many));
            }
            else if (ATOMID(type) == ATOMID("iods"))
            {
                AddVersionAndFlags();
                AddProperty(new MP4DescriptorProperty(
                    *this, NULL, MP4FileIODescrTag, MP4FileODescrTag, Required,
                    OnlyOne));
                /*
                 * m???
                 */
            ...
            else if (ATOMID(type) == ATOMID("stco"))
            {
                ...
                pTable->AddProperty(new MP4Integer32Property(
                    pTable->GetParentAtom(), "chunkOffset"));
            }
            else if (ATOMID(type) == ATOMID("stsh"))
            {
                ...
                pTable->AddProperty(new MP4Integer32Property(
                    pTable->GetParentAtom(), "shadowedSampleNumber"));
                pTable->AddProperty(new MP4Integer32Property(
                    pTable->GetParentAtom(), "syncSampleNumber"));
            }
            else if (ATOMID(type) == ATOMID("stss"))
            {
                ...
                pTable->AddProperty(new MP4Integer32Property(
                    pTable->GetParentAtom(), "sampleNumber"));
            }
            else if (ATOMID(type) == ATOMID("stts"))
            {
                ...
                pTable->AddProperty(new MP4Integer32Property(
                    pTable->GetParentAtom(), "sampleCount"));
                pTable->AddProperty(new MP4Integer32Property(
                    pTable->GetParentAtom(), "sampleDelta"));
            }
            ...
            else if (ATOMID(type) == ATOMID("trex"))
            {
                ...
                AddProperty(/* 3 */
                            new MP4Integer32Property(
                                *this, "defaultSampleDesriptionIndex"));
                AddProperty(/* 4 */
                            new MP4Integer32Property(*this,
