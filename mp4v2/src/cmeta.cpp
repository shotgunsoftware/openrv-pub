...
extern "C"
{
    ...
    bool MP4TagsAddArtwork(const MP4Tags* tags, MP4TagArtwork* artwork)
    {
    ...
    const MP4Tags* MP4TagsAlloc()
    {
        ...
        catch (std::bad_alloc)
        {
            ...
            mp4v2::impl::log.errorf("%s: memory allocation error",
                                    __FUNCTION__);
        }
        catch (Exception* x)
        {
    ...
    bool MP4TagsRemoveArtwork(const MP4Tags* tags, uint32_t index)
    {
        if (!tags || !tags->__handle)
            return false;
    ...
    bool MP4TagsSetArtwork(const MP4Tags* tags, uint32_t index,
    ...
    bool MP4TagsSetName(const MP4Tags* m, const char* value)
    {
        if (!m || !m->__handle)
            return false;
    ...
    bool MP4TagsSetArtist(const MP4Tags* m, const char* value)
    {
        if (!m || !m->__handle)
            return false;
    ...
    bool MP4TagsSetAlbumArtist(const MP4Tags* m, const char* value)
    {
        if (!m || !m->__handle)
            return false;
    ...
    bool MP4TagsSetAlbum(const MP4Tags* m, const char* value)
    {
        if (!m || !m->__handle)
            return false;
    ...
    bool MP4TagsSetGrouping(const MP4Tags* m, const char* value)
    {
        if (!m || !m->__handle)
            return false;
    ...
    bool MP4TagsSetComposer(const MP4Tags* m, const char* value)
    {
        if (!m || !m->__handle)
            return false;
    ...
    bool MP4TagsSetComments(const MP4Tags* m, const char* value)
    {
        if (!m || !m->__handle)
            return false;
    ...
    bool MP4TagsSetGenre(const MP4Tags* m, const char* value)
    {
        if (!m || !m->__handle)
            return false;
    ...
    bool MP4TagsSetGenreType(const MP4Tags* m, const uint16_t* value)
    {
        if (!m || !m->__handle)
            return false;
    ...
    bool MP4TagsSetReleaseDate(const MP4Tags* m, const char* value)
    {
        if (!m || !m->__handle)
            return false;
    ...
    bool MP4TagsSetTrack(const MP4Tags* m, const MP4TagTrack* value)
    {
        if (!m || !m->__handle)
            return false;
    ...
    bool MP4TagsSetDisk(const MP4Tags* m, const MP4TagDisk* value)
    {
        if (!m || !m->__handle)
            return false;
    ...
    bool MP4TagsSetTempo(const MP4Tags* m, const uint16_t* value)
    {
        if (!m || !m->__handle)
            return false;
    ...
    bool MP4TagsSetCompilation(const MP4Tags* m, const uint8_t* value)
    {
        if (!m || !m->__handle)
            return false;
    ...
    bool MP4TagsSetTVShow(const MP4Tags* m, const char* value)
    {
        if (!m || !m->__handle)
            return false;
    ...
    bool MP4TagsSetTVNetwork(const MP4Tags* m, const char* value)
    {
        if (!m || !m->__handle)
            return false;
    ...
    bool MP4TagsSetTVEpisodeID(const MP4Tags* m, const char* value)
    {
        if (!m || !m->__handle)
            return false;
    ...
    bool MP4TagsSetTVSeason(const MP4Tags* m, const uint32_t* value)
    {
        if (!m || !m->__handle)
            return false;
    ...
    bool MP4TagsSetTVEpisode(const MP4Tags* m, const uint32_t* value)
    {
        if (!m || !m->__handle)
            return false;
    ...
    bool MP4TagsSetSortName(const MP4Tags* m, const char* value)
    {
        if (!m || !m->__handle)
            return false;
    ...
    bool MP4TagsSetSortArtist(const MP4Tags* m, const char* value)
    {
        if (!m || !m->__handle)
            return false;
    ...
    bool MP4TagsSetSortAlbumArtist(const MP4Tags* m, const char* value)
    {
        if (!m || !m->__handle)
            return false;
    ...
    bool MP4TagsSetSortAlbum(const MP4Tags* m, const char* value)
    {
        if (!m || !m->__handle)
            return false;
    ...
    bool MP4TagsSetSortComposer(const MP4Tags* m, const char* value)
    {
        if (!m || !m->__handle)
            return false;
    ...
    bool MP4TagsSetSortTVShow(const MP4Tags* m, const char* value)
    {
        if (!m || !m->__handle)
            return false;
    ...
    bool MP4TagsSetDescription(const MP4Tags* m, const char* value)
    {
        if (!m || !m->__handle)
            return false;
    ...
    bool MP4TagsSetLongDescription(const MP4Tags* m, const char* value)
    {
        if (!m || !m->__handle)
            return false;
    ...
    bool MP4TagsSetLyrics(const MP4Tags* m, const char* value)
    {
        if (!m || !m->__handle)
            return false;
    ...
    bool MP4TagsSetCopyright(const MP4Tags* m, const char* value)
    {
        if (!m || !m->__handle)
            return false;
    ...
    bool MP4TagsSetEncodingTool(const MP4Tags* m, const char* value)
    {
        if (!m || !m->__handle)
            return false;
    ...
    bool MP4TagsSetEncodedBy(const MP4Tags* m, const char* value)
    {
        if (!m || !m->__handle)
            return false;
    ...
    bool MP4TagsSetPurchaseDate(const MP4Tags* m, const char* value)
    {
        if (!m || !m->__handle)
            return false;
    ...
    bool MP4TagsSetPodcast(const MP4Tags* m, const uint8_t* value)
    {
        if (!m || !m->__handle)
            return false;
    ...
    bool MP4TagsSetKeywords(const MP4Tags* m, const char* value)
    {
        if (!m || !m->__handle)
            return false;
    ...
    bool MP4TagsSetCategory(const MP4Tags* m, const char* value)
    {
        if (!m || !m->__handle)
            return false;
    ...
    bool MP4TagsSetHDVideo(const MP4Tags* m, const uint8_t* value)
    {
        if (!m || !m->__handle)
            return false;
    ...
    bool MP4TagsSetMediaType(const MP4Tags* m, const uint8_t* value)
    {
        if (!m || !m->__handle)
            return false;
    ...
    bool MP4TagsSetContentRating(const MP4Tags* m, const uint8_t* value)
    {
        if (!m || !m->__handle)
            return false;
    ...
    bool MP4TagsSetGapless(const MP4Tags* m, const uint8_t* value)
    {
        if (!m || !m->__handle)
            return false;
    ...
    bool MP4TagsSetITunesAccount(const MP4Tags* m, const char* value)
    {
        if (!m || !m->__handle)
            return false;
    ...
    bool MP4TagsSetITunesAccountType(const MP4Tags* m, const uint8_t* value)
    {
        if (!m || !m->__handle)
            return false;
    ...
    bool MP4TagsSetITunesCountry(const MP4Tags* m, const uint32_t* value)
    {
        if (!m || !m->__handle)
            return false;
    ...
    bool MP4TagsSetContentID(const MP4Tags* m, const uint32_t* value)
    {
        if (!m || !m->__handle)
            return false;
    ...
    bool MP4TagsSetArtistID(const MP4Tags* m, const uint32_t* value)
    {
        if (!m || !m->__handle)
            return false;
    ...
    bool MP4TagsSetPlaylistID(const MP4Tags* m, const uint64_t* value)
    {
        if (!m || !m->__handle)
            return false;
    ...
    bool MP4TagsSetGenreID(const MP4Tags* m, const uint32_t* value)
    {
        if (!m || !m->__handle)
            return false;
    ...
    bool MP4TagsSetComposerID(const MP4Tags* m, const uint32_t* value)
    {
        if (!m || !m->__handle)
            return false;
    ...
    bool MP4TagsSetXID(const MP4Tags* m, const char* value)
    {
        if (!m || !m->__handle)
            return false;
    ...
    void MP4ItmfItemFree(MP4ItmfItem* item) { itmf::genericItemFree(item); }

    ///////////////////////////////////////////////////////////////////////////////

    void MP4ItmfItemListFree(MP4ItmfItemList* list)
    {
                                              ...
                                              const char* name)
    {
        ...
        try
        {
            return itmf::genericGetItemsByMeaning(*(MP4File*)hFile, meaning,
                                                  name ? name : "");
        }
        catch (Exception* x)
        {
