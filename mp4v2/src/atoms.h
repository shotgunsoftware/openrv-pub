...
class MP4AVdnAtom : public MP4Atom {
public:
    MP4AVdnAtom(MP4File &file);
    void Generate();
private:
    MP4AVdnAtom();
    MP4AVdnAtom( const MP4AVdnAtom &src );
    MP4AVdnAtom &operator= ( const MP4AVdnAtom &src );
};

class MP4ACLRAtom : public MP4Atom {
public:
    MP4ACLRAtom(MP4File &file);
private:
    MP4ACLRAtom();
    MP4ACLRAtom( const MP4ACLRAtom &src );
    MP4ACLRAtom &operator= ( const MP4ACLRAtom &src );
};

class MP4APRGAtom : public MP4Atom {
public:
    MP4APRGAtom(MP4File &file);
private:
    MP4APRGAtom();
    MP4APRGAtom( const MP4APRGAtom &src );
    MP4APRGAtom &operator= ( const MP4APRGAtom &src );
};

class MP4ARESAtom : public MP4Atom {
public:
    MP4ARESAtom(MP4File &file);
    void Read();
private:
    MP4ARESAtom();
    MP4ARESAtom( const MP4ARESAtom &src );
    MP4ARESAtom &operator= ( const MP4ARESAtom &src );
};
...
class MP4TmcdAtom : public MP4Atom {
public:
    MP4TmcdAtom(MP4File &file);
    void Read();
private:
    MP4TmcdAtom();
    MP4TmcdAtom( const MP4TmcdAtom &src );
    MP4TmcdAtom &operator= ( const MP4TmcdAtom &src );
};

class MP4TmcdNameAtom : public MP4Atom {
public:
    MP4TmcdNameAtom(MP4File &file);
    void Read();
private:
    MP4TmcdNameAtom();
    MP4TmcdNameAtom( const MP4TmcdAtom &src );
    MP4TmcdNameAtom &operator= ( const MP4TmcdAtom &src );
};
