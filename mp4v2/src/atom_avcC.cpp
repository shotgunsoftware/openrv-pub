...
namespace mp4v2
{
    namespace impl
    {
        ...
        {
        public:
            SizeTableProperty(MP4Atom& parentAtom, const char* name,
        ...
        protected:
            void ReadEntry(MP4File& file, uint32_t index)
            {
                ...
                MP4IntegerProperty* pIntProp =
                    (MP4IntegerProperty*)m_pProperties[0];
                // set the size in the bytes property
                MP4BytesProperty* pBytesProp =
                    (MP4BytesProperty*)m_pProperties[1];
            ...
            : MP4Atom(file, "avcC")
        {
            ...
            AddProperty(
                new MP4Integer8Property(*this, "configurationVersion")); /* 0 */

            AddProperty(
                new MP4Integer8Property(*this, "AVCProfileIndication")); /* 1 */

            AddProperty(new MP4Integer8Property(
                *this, "profile_compatibility")); /* 2 */

            AddProperty(
                new MP4Integer8Property(*this, "AVCLevelIndication")); /* 3 */

            AddProperty(new MP4BitfieldProperty(*this, "reserved", 6)); /* 4 */
            AddProperty(new MP4BitfieldProperty(*this, "lengthSizeMinusOne",
                                                2));                     /* 5 */
            AddProperty(new MP4BitfieldProperty(*this, "reserved1", 3)); /* 6 */
            pCount =
                new MP4BitfieldProperty(*this, "numOfSequenceParameterSets", 5);
            ...
            pTable->AddProperty(new MP4Integer16Property(
                pTable->GetParentAtom(), "sequenceParameterSetLength"));
            pTable->AddProperty(new MP4BytesProperty(
                pTable->GetParentAtom(), "sequenceParameterSetNALUnit"));

            MP4Integer8Property* pCount2 =
                new MP4Integer8Property(*this, "numOfPictureParameterSets");
            AddProperty(pCount2); /* 9 */

            pTable = new SizeTableProperty(*this, "pictureEntries", pCount2);
            AddProperty(pTable); /* 10 */
            pTable->AddProperty(new MP4Integer16Property(
                pTable->GetParentAtom(), "pictureParameterSetLength"));
            pTable->AddProperty(new MP4BytesProperty(
                pTable->GetParentAtom(), "pictureParameterSetNALUnit"));
        }
    ...
    m_pProperties[7]->SetReadOnly(true);
        ...
        void MP4AvcCAtom::Clone(MP4AvcCAtom* dstAtom)
        {
            ...
            ((MP4Integer8Property*)dstProperty)
                ->SetValue(
            ...
            ((MP4BitfieldProperty*)dstProperty)
                ->SetValue(
