...
namespace mp4v2
{
    namespace impl
    {
        ...
        private:
            ...
            MP4ContentClassDescriptor&
            operator=(const MP4ContentClassDescriptor& src);
        };
        ...
        private:
            ...
            MP4ShortTextDescriptor&
            operator=(const MP4ShortTextDescriptor& src);
        };
        ...
        private:
            ...
            MP4ExpandedTextDescriptor&
            operator=(const MP4ExpandedTextDescriptor& src);
        };
        ...
        private:
            ...
            MP4SmpteCameraDescriptor&
            operator=(const MP4SmpteCameraDescriptor& src);
        };
        ...
        private:
            ...
            MP4UnknownOCIDescriptor&
            operator=(const MP4UnknownOCIDescriptor& src);
        };

        extern MP4Descriptor* CreateOCIDescriptor(MP4Atom& parentAtom,
                                                  uint8_t tag);
