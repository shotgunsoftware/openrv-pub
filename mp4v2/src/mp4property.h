...
namespace mp4v2
{
    namespace impl
    {
        ...
        public:
            ...
            MP4Atom& GetParentAtom() { return m_parentAtom; }
            ...
            void SetImplicit(bool value = true) { m_implicit = value; }
...
#define MP4INTEGER_PROPERTY_DECL2(isize, xsize)                                \
    ...
    public:                                                                    \
        ...
        {                                                                      \
            ...
            m_values[0] = 0;                                                   \
                                                                               ...
                                                                               \
        MP4PropertyType GetType() { return Integer##xsize##Property; }         \
                                                                               \
        uint32_t GetCount() { return m_values.Size(); }                        \
        void SetCount(uint32_t count) { m_values.Resize(count); }              \
                                                                               \
        ...
        {                                                                      \
            ...
            {                                                                  \
                ...
                throw new PlatformException(msg.str().c_str(), EACCES,         \
                                            __FILE__, __LINE__, __FUNCTION__); \
            }                                                                  \
            m_values[index] = value;                                           \
        }                                                                      \
        void AddValue(uint##isize##_t value) { m_values.Add(value); }          \
        void InsertValue(uint##isize##_t value, uint32_t index)                \
        {                                                                      \
            m_values.Insert(value, index);                                     \
        }                                                                      \
        void DeleteValue(uint32_t index) { m_values.Delete(index); }           \
        void IncrementValue(int32_t increment = 1, uint32_t index = 0)         \
        {                                                                      \
        ...
        void Dump(uint8_t indent, bool dumpImplicits, uint32_t index = 0);     \
                                                                               \
    protected:                                                                 \
    ...
    private:                                                                   \
        ...
        MP4Integer##xsize##Property&                                           \
        operator=(const MP4Integer##xsize##Property& src);                     \
    };

#define MP4INTEGER_PROPERTY_DECL(size) MP4INTEGER_PROPERTY_DECL2(size, size)
        ...
        {
        public:
            MP4BitfieldProperty(MP4Atom& parentAtom, const char* name,
                                uint8_t numBits)
            ...
            uint8_t GetNumBits() { return m_numBits; }

            void SetNumBits(uint8_t numBits) { m_numBits = numBits; }
        ...
        public:
            ...
            MP4PropertyType GetType() { return Float32Property; }

            uint32_t GetCount() { return m_values.Size(); }

            void SetCount(uint32_t count) { m_values.Resize(count); }

            float GetValue(uint32_t index = 0) { return m_values[index]; }
            ...
            void AddValue(float value) { m_values.Add(value); }
            ...
            bool IsFixed16Format() { return m_useFixed16Format; }
            ...
            bool IsFixed32Format() { return m_useFixed32Format; }
        ...
        public:
            MP4StringProperty(MP4Atom& parentAtom, const char* name,
                              bool useCountedFormat = false,
                              bool useUnicode = false, bool arrayMode = false);

            ~MP4StringProperty();

            MP4PropertyType GetType() { return StringProperty; }

            uint32_t GetCount() { return m_values.Size(); }

            void SetCount(uint32_t count);

            const char* GetValue(uint32_t index = 0) { return m_values[index]; }
            ...
            bool IsCountedFormat() { return m_useCountedFormat; }
            ...
            bool IsExpandedCountedFormat() { return m_useExpandedCount; }
            ...
            bool IsUnicode() { return m_useUnicode; }

            void SetUnicode(bool useUnicode) { m_useUnicode = useUnicode; }

            uint32_t GetFixedLength() { return m_fixedLength; }
        ...
        protected:
            bool m_arrayMode; // during read/write ignore index and read/write
                              // full array
        ...
        {
        public:
            MP4BytesProperty(MP4Atom& parentAtom, const char* name,
                             uint32_t valueSize = 0,
                             uint32_t defaultValueSize = 0);

            ~MP4BytesProperty();

            MP4PropertyType GetType() { return BytesProperty; }
            ...
            {
                return string((const char*)m_values[index], m_valueSizes[index])
                       != s;
            }
            ...
            uint32_t GetFixedSize() { return m_fixedValueSize; }
        ...
        {
        public:
            MP4TableProperty(MP4Atom& parentAtom, const char* name,
                             MP4IntegerProperty* pCountProperty);

            ~MP4TableProperty();

            MP4PropertyType GetType() { return TableProperty; }
            ...
            virtual uint32_t GetCount() { return m_pCountProperty->GetValue(); }
        ...
        public:
            ...
            MP4PropertyType GetType() { return DescriptorProperty; }

            void SetParentAtom(MP4Atom* pParentAtom);

            void SetSizeLimit(uint64_t sizeLimit) { m_sizeLimit = sizeLimit; }

            uint32_t GetCount() { return m_pDescriptors.Size(); }

            void SetCount(uint32_t count) { m_pDescriptors.Resize(count); }
        ...
        protected:
            virtual MP4Descriptor* CreateDescriptor(MP4Atom& parentAtom,
                                                    uint8_t tag);
        ...
        {
        public:
            MP4QosQualifierProperty(MP4Atom& parentAtom,
                                    const char* name = NULL,
                                    uint8_t tagsStart = 0, uint8_t tagsEnd = 0,
                                    bool mandatory = false,
                                    bool onlyOne = false)
                : MP4DescriptorProperty(parentAtom, name, tagsStart, tagsEnd,
                                        mandatory, onlyOne)
            {
            }
        ...
        private:
            ...
            MP4QosQualifierProperty&
            operator=(const MP4QosQualifierProperty& src);
        };
        ...
        public:
            explicit MP4LanguageCodeProperty(
                MP4Atom& parentAtom, const char*,
                bmff::LanguageCode = bmff::ILC_UND);
            MP4LanguageCodeProperty(MP4Atom& parentAtom, const char*,
                                    const string&);
        ...
        private:
            ...
            MP4LanguageCodeProperty&
            operator=(const MP4LanguageCodeProperty& src);
        };
        ...
        public:
            explicit MP4BasicTypeProperty(MP4Atom& parentAtom, const char*,
                                          itmf::BasicType = itmf::BT_UNDEFINED);
