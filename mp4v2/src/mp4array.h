...
namespace mp4v2
{
    namespace impl
    {
        ...
        public:
            ...
            inline MP4ArrayIndex Size(void) { return m_numElements; }

            inline MP4ArrayIndex MaxSize(void) { return m_maxNumElements; }
...
#define MP4ARRAY_DECL(name, type)                                              \
    ...
    {                                                                          \
    public:                                                                    \
        name##Array() { m_elements = NULL; }                                   \
                                                                               \
        ~name##Array() { MP4Free(m_elements); }                                \
                                                                               \
        ...
        {                                                                      \
            ...
            {                                                                  \
                throw new PlatformException("illegal array index", ERANGE,     \
                                            __FILE__, __LINE__, __FUNCTION__); \
            }                                                                  \
            if (m_numElements == m_maxNumElements)                             \
            {                                                                  \
                m_maxNumElements =                                             \
                    max(m_maxNumElements, (MP4ArrayIndex)1) * 2;               \
                m_elements = (type*)MP4Realloc(                                \
                    m_elements, m_maxNumElements * sizeof(type));              \
            }                                                                  \
        ...
        {                                                                      \
            ...
            {                                                                  \
                ostringstream msg;                                             \
                msg << "illegal array index: " << index << " of "              \
                    << m_numElements;                                          \
