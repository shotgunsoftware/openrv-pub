                            ...
                            uint16_t matrixIndex)
{
    ...
    {
        AddChildAtom(MakeTrackName(trackId, "mdia.minf.stbl.stsd.jpeg"), "colr");
        SetTrackIntegerProperty(trackId, "mdia.minf.stbl.stsd.jpeg.colr.primariesIndex", primariesIndex);
        SetTrackIntegerProperty(trackId, "mdia.minf.stbl.stsd.jpeg.colr.transferFunctionIndex", transferFunctionIndex);
        SetTrackIntegerProperty(trackId, "mdia.minf.stbl.stsd.jpeg.colr.matrixIndex", matrixIndex);
    }
