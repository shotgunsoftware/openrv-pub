...
typedef void (*MP4LogCallback)(MP4LogLevel loglevel, const char* fmt,
                               va_list ap);
 ...
 */
typedef uint32_t (*encryptFunc_t)(uint32_t, uint32_t, uint8_t*, uint32_t*,
                                  uint8_t**);

/*****************************************************************************/

#define MP4_INVALID_FILE_HANDLE \
    ((MP4FileHandle)NULL) /**< Constant: invalid MP4FileHandle. */
#define MP4_INVALID_TRACK_ID \
    ((MP4TrackId)0) /**< Constant: invalid MP4TrackId. */
#define MP4_INVALID_SAMPLE_ID \
    ((MP4SampleId)0) /**< Constant: invalid MP4SampleId. */
#define MP4_INVALID_TIMESTAMP \
    ((MP4Timestamp) - 1) /**< Constant: invalid MP4Timestamp. */
#define MP4_INVALID_DURATION \
    ((MP4Duration) - 1) /**< Constant: invalid MP4Duration. */
#define MP4_INVALID_EDIT_ID                          \
    ((MP4EditId)0) /**< Constant: invalid MP4EditId. \
                    */
...
#define MP4_IS_VIDEO_TRACK_TYPE(type) (!strcasecmp(type, MP4_VIDEO_TRACK_TYPE))

#define MP4_IS_AUDIO_TRACK_TYPE(type) (!strcasecmp(type, MP4_AUDIO_TRACK_TYPE))

#define MP4_IS_CNTL_TRACK_TYPE(type) (!strcasecmp(type, MP4_CNTL_TRACK_TYPE))

#define MP4_IS_OD_TRACK_TYPE(type) (!strcasecmp(type, MP4_OD_TRACK_TYPE))

#define MP4_IS_SCENE_TRACK_TYPE(type) (!strcasecmp(type, MP4_SCENE_TRACK_TYPE))

#define MP4_IS_HINT_TRACK_TYPE(type) (!strcasecmp(type, MP4_HINT_TRACK_TYPE))
...
#define MP4_IS_MPEG4_AAC_AUDIO_TYPE(mpeg4Type)       \
    (((mpeg4Type) >= MP4_MPEG4_AAC_MAIN_AUDIO_TYPE   \
     ...
     || (mpeg4Type) == MP4_MPEG4_AAC_SCALABLE_AUDIO_TYPE || (mpeg4Type) == 17)
...
#define MP4_IS_MPEG1_VIDEO_TYPE(type) ((type) == MP4_MPEG1_VIDEO_TYPE)
...
#define MP4_IS_MPEG4_VIDEO_TYPE(type) ((type) == MP4_MPEG4_VIDEO_TYPE)
...
MP4V2_EXPORT
bool MP4Make3GPCompliant(const char* fileName, char* majorBrand DEFAULT(0),
...
MP4V2_EXPORT
MP4Timestamp MP4GetTrackEditStart(MP4FileHandle hFile, MP4TrackId trackId,
                                  MP4EditId editId);

MP4V2_EXPORT
MP4Duration
MP4GetTrackEditTotalDuration(MP4FileHandle hFile, MP4TrackId trackId,
                             MP4EditId editId DEFAULT(MP4_INVALID_EDIT_ID));

MP4V2_EXPORT
MP4Timestamp MP4GetTrackEditMediaStart(MP4FileHandle hFile, MP4TrackId trackId,
                                       MP4EditId editId);
...
MP4V2_EXPORT
MP4SampleId MP4GetSampleIdFromEditTime(MP4FileHandle hFile, MP4TrackId trackId,
                                       MP4Timestamp when,
                                       MP4Timestamp* pStartTime DEFAULT(NULL),
                                       MP4Duration* pDuration DEFAULT(NULL));
...
MP4V2_EXPORT
uint64_t MP4ConvertFromMovieDuration(MP4FileHandle hFile, MP4Duration duration,
                                     uint32_t timeScale);

MP4V2_EXPORT
uint64_t MP4ConvertFromTrackTimestamp(MP4FileHandle hFile, MP4TrackId trackId,
                                      MP4Timestamp timeStamp,
                                      uint32_t timeScale);

MP4V2_EXPORT
MP4Timestamp MP4ConvertToTrackTimestamp(MP4FileHandle hFile, MP4TrackId trackId,
 ...
 */
MP4V2_EXPORT
uint64_t MP4ConvertFromTrackDuration(MP4FileHandle hFile, MP4TrackId trackId,
                                     MP4Duration duration, uint32_t timeScale);
 ...
 */
MP4V2_EXPORT
MP4Duration MP4ConvertToTrackDuration(MP4FileHandle hFile, MP4TrackId trackId,
...
MP4V2_EXPORT
uint8_t* Base64ToBinary(const char* pData, uint32_t decodeSize,
                        uint32_t* pDataSize);
