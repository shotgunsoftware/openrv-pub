...
namespace Eigen
{
    ...
    /** \ingroup IterativeLinearSolvers_Module
      ...
      *
      * This class allows to approximately solve for A.x = b problems assuming A
      is a diagonal matrix.
      * In other words, this preconditioner neglects all off diagonal entries
      and, in Eigen's language, solves for:
        \code
      ...
      *
      * This preconditioner is suitable for both selfadjoint and general
      problems.
    ...
    public:
        ...
        solve(const MatrixBase<Rhs>& b) const
        {
            ...
            eigen_assert(m_invdiag.size() == b.rows()
                         && "DiagonalPreconditioner::solve(): invalid number "
    ...
    /** \ingroup IterativeLinearSolvers_Module
     * \brief A naive preconditioner which approximates any matrix as the
     * identity matrix
     *
     * \implsparsesolverconcept
     *
