    ...
    namespace internal
    {
        ...
        static Packet4ui p4ui_CONJ_XOR =
            vec_mergeh((Packet4ui)p4i_ZERO,
                       (Packet4ui)p4f_MZERO); //{ 0x00000000, 0x80000000,
                                                      ...
                                                      const Packet2cf& b)
        {
            ...
            return Packet2cf(pdiv(
                res.v, padd<Packet4f>(s, vec_perm(s, s, p16uc_COMPLEX32_REV))));
        }
        ...
        EIGEN_STRONG_INLINE void ptranspose(PacketBlock<Packet2cf, 2>& kernel)
        {
            ...
            kernel.packet[1].v = vec_perm(
                kernel.packet[0].v, kernel.packet[1].v, p16uc_TRANSPOSE64_LO);
                                             ...
                                             const Packet2cf& elsePacket)
        {
            ...
            result.v = reinterpret_cast<Packet4f>(pblend<Packet2d>(
                ifPacket, reinterpret_cast<Packet2d>(thenPacket.v),
...
//---------- double ----------
        ...
        {
            return Packet1cd(
                pxor(a.v, reinterpret_cast<Packet2d>(p2ul_CONJ_XOR2)));
        }
                                                      ...
                                                      const Packet1cd& b)
        {
            ...
            v2 = reinterpret_cast<Packet2d>(
                vec_sld(reinterpret_cast<Packet4ui>(v2),
                                                      ...
                                                      const Packet1cd& b)
        {
            ...
            return Packet1cd(pdiv(
                res.v, padd<Packet2d>(s, vec_perm(s, s, p16uc_REVERSE64))));
        }
