...
namespace Eigen
{
    ...
    namespace internal
    {
        ...
        */
            ...
            plog<Packet4f>(const Packet4f& _x)
        {
            ...
            Packet4ui isvalid_mask =
                reinterpret_cast<Packet4ui>(vec_cmpge(x, p4f_ZERO));
            Packet4ui iszero_mask =
                reinterpret_cast<Packet4ui>(vec_cmpeq(x, p4f_ZERO));
            ...
            pexp<Packet4f>(const Packet4f& _x)
        {
            ...
            // Altivec's max & min operators just drop silent NaNs. Check NaNs
            // in inputs and return them unmodified.
            Packet4ui isnumber_mask =
                reinterpret_cast<Packet4ui>(vec_cmpeq(_x, _x));
            return vec_sel(_x,
                           pmax(pmul(y, reinterpret_cast<Packet4f>(emm0)), _x),
                           isnumber_mask);
        }
    ...
    || (EIGEN_GNUC_AT(6, 1) && __GNUC_PATCHLEVEL__ >= 1)
            ...
            pexp<Packet2d>(const Packet2d& _x)
        {
            ...
            // vec_xxsldi intrinsic but it is not supported by some gcc
            // versions. So we shift (52-32) bits and do a word swap with zeros.
            ...
            return vec_sel(_x,
                           pmax(pmul(x, reinterpret_cast<Packet2d>(emm0)), _x),
                           isnumber_mask);
        }
#endif
