...
// to leverage AVX instructions.
                                                      ...
                                                      const Packet2cf& b)
        {
            ...
            //   return Packet2cf(_mm_addsub_ps(_mm_mul_ps(vec4f_swizzle1(a.v,
            //   0, 0, 2, 2), b.v),
            //                                  _mm_mul_ps(vec4f_swizzle1(a.v,
            //                                  1, 1, 3, 3),
            //                                             vec4f_swizzle1(b.v,
            //                                             1, 0, 3, 2))));
#else
        ...
        pset1<Packet2cf>(const std::complex<float>& from)
        {
            ...
            // Workaround annoying "may be used uninitialized in this function"
            // warning with gcc 4.2
            res.v = _mm_loadl_pi(_mm_set1_ps(0.0f),
                                 reinterpret_cast<const __m64*>(&from));
...
#pragma GCC diagnostic pop
        ...
        pfirst<Packet2cf>(const Packet2cf& a)
        {
            ...
            // Workaround gcc 4.2 ICE - this is not performance wise ideal, but
            // who cares... This workaround also fix invalid code generation
            // with gcc 4.3
        ...
        {
            return Packet2cf(
                _mm_castpd_ps(preverse(Packet2d(_mm_castps_pd(a.v)))));
        }
        ...
        template <> struct conj_helper<Packet2cf, Packet2cf, false, true>
        {
                                               ...
                                               const Packet2cf& b) const
            {
                ...
                return Packet2cf(_mm_add_ps(
                    _mm_xor_ps(_mm_mul_ps(vec4f_swizzle1(a.v, 0, 0, 2, 2), b.v),
                               mask),
                                                      ...
                                                      const Packet2cf& b)
        {
            ...
            Packet2cf res =
                conj_helper<Packet2cf, Packet2cf, false, true>().pmul(a, b);
            __m128 s = _mm_mul_ps(b.v, b.v);
            return Packet2cf(_mm_div_ps(
                res.v, _mm_add_ps(s, _mm_castsi128_ps(_mm_shuffle_epi32(
...
// to leverage AVX instructions.
        ...
        template <> struct conj_helper<Packet1cd, Packet1cd, false, true>
        {
                                               ...
                                               const Packet1cd& b) const
            {
                ...
                return Packet1cd(_mm_add_pd(
                    _mm_xor_pd(_mm_mul_pd(vec2d_swizzle1(a.v, 0, 0), b.v),
                               mask),
                    _mm_mul_pd(vec2d_swizzle1(a.v, 1, 1),
                               vec2d_swizzle1(b.v, 1, 0))));
#endif
                                                      ...
                                                      const Packet1cd& b)
        {
            // TODO optimize it for SSE3 and 4
            Packet1cd res =
                conj_helper<Packet1cd, Packet1cd, false, true>().pmul(a, b);
        ...
        {
            __m128d result =
                pblend<Packet2d>(ifPacket, _mm_castps_pd(thenPacket.v),
        ...
        {
            return Packet2cf(
                _mm_loadl_pi(a.v, reinterpret_cast<const __m64*>(&b)));
        }
        ...
        {
            return Packet2cf(
                _mm_loadh_pi(a.v, reinterpret_cast<const __m64*>(&b)));
        }
