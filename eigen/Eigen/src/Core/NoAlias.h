...
namespace Eigen
{
     ...
     * expression. More precisely it alloas to bypass the EvalBeforeAssignBit
     * flag of the source expression. It is the return type of
     * MatrixBase::noalias() and most of the time this is the only way it is
     * used.
     *
    ...
    public:
        ...
        explicit NoAlias(ExpressionType& expression)
