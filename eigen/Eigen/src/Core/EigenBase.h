...
namespace Eigen
{
    ...
    /** \class EigenBase
     *
     * Common base class for all classes T such that MatrixBase has an
     * operator=(T) and a constructor MatrixBase(T).
     *
     * In other words, an EigenBase object is an object that can be copied into
     * a MatrixBase.
     *
    ...
    template <typename Derived> struct EigenBase
    {
         ...
         * \deprecated Since Eigen 3.3, its usage is deprecated. Use
         * Eigen::Index instead.
     ...
     * const function which does the actual job. In practice, this allows any
     * user to write its own special matrix without having to modify MatrixBase
     *
