    ...
    namespace internal
    {
        ...
        struct scalar_sum_op : binary_op_base<LhsScalar, RhsScalar>
        {
            typedef typename ScalarBinaryOpTraits<
                LhsScalar, RhsScalar, scalar_sum_op>::ReturnType result_type;
        ...
        struct functor_traits<scalar_sum_op<LhsScalar, RhsScalar>>
        {
            enum
            {
                Cost = (NumTraits<LhsScalar>::AddCost
         ...
         * expressions. This is required to solve Bug 426.
        ...
        /** \internal
         * \brief Template functor to compute the conjugate product of two
         * scalars
         *
        ...
        struct scalar_conj_product_op : binary_op_base<LhsScalar, RhsScalar>
        {
            ...
            typedef typename ScalarBinaryOpTraits<
                LhsScalar, RhsScalar, scalar_conj_product_op>::ReturnType
                result_type;
            ...
            operator()(const LhsScalar& a, const RhsScalar& b) const
            {
                return conj_helper<LhsScalar, RhsScalar, Conj, false>().pmul(a,
                                                                             b);
            }
        ...
        {
            typedef typename ScalarBinaryOpTraits<
                LhsScalar, RhsScalar, scalar_min_op>::ReturnType result_type;
        ...
        {
            typedef typename ScalarBinaryOpTraits<
                LhsScalar, RhsScalar, scalar_max_op>::ReturnType result_type;
        ...
        {
            typedef typename ScalarBinaryOpTraits<
                Scalar, Exponent, scalar_pow_op>::ReturnType result_type;
#ifndef EIGEN_SCALAR_BINARY_OP_PLUGIN
...
#endif
            EIGEN_DEVICE_FUNC
            inline result_type operator()(const Scalar& a,
        ...
        struct scalar_difference_op : binary_op_base<LhsScalar, RhsScalar>
        {
            typedef
                typename ScalarBinaryOpTraits<LhsScalar, RhsScalar,
                                              scalar_difference_op>::ReturnType
                    result_type;
#ifndef EIGEN_SCALAR_BINARY_OP_PLUGIN
        ...
        //---------- binary functors bound to a constant, thus appearing as a
        // unary functor ----------

        // The following two classes permits to turn any binary functor into a
        // unary one with one argument bound to a constant value. They are
        // analogues to std::binder1st/binder2nd but with the following
        // differences:
        //  - they are compatible with packetOp
        //  - they are portable across C++ versions (the std::binder* are
        //  deprecated in C++11)
        template <typename BinaryOp> struct bind1st_op : BinaryOp
        {
            ...
            typedef
                typename BinaryOp::second_argument_type second_argument_type;
