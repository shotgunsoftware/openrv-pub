...
namespace Eigen
{
    ...
    namespace internal
    {
                                                      ...
                                                      MatrixType, false>
        {
            ...
            typedef Matrix<typename RotationDerived::Scalar, Dim, Dim>
                ReturnType;
     ...
     */
    template <typename _Scalar, int _Rows, int _Cols, int _Storage,
    ...
    namespace internal
    {
        ...
        /** \internal
         *
         * Helper function to return an arbitrary rotation object to a rotation
         * matrix.
         *
         ...
         *
         * \sa class Transform, class Rotation2D, class Quaternion, class
         * AngleAxis
         */
