...
namespace Eigen
{
     ...
     * transformation, but rather to make easier the constructions and updates
    ...
    public:
        ...
        /** Constructs and initialize the translation transformation from a
         * vector of translation coefficients */
