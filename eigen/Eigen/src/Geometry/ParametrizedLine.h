...
namespace Eigen
{
     ...
     *
     * A parametrized line is defined by an origin point \f$ \mathbf{o} \f$ and
     * a unit direction vector \f$ \mathbf{d} \f$ such that the line corresponds
     * to the set \f$ l(t) = \mathbf{o} + t \mathbf{d} \f$, \f$ t \in \mathbf{R}
     * \f$.
     *
    ...
    public:
        ...
        /** Initializes a parametrized line of direction \a direction and origin
         * \a origin.
        ...
        /** \returns the squared distance of a point \a p to its projection onto
         * the line \c *this.
         * \sa distance()
         */
        ...
        /** \returns the distance of a point \a p to its projection onto the
         * line \c *this.
         * \sa squaredDistance()
         */
    ...
    /** \returns the parameter value of the intersection between \c *this and
     * the given \a hyperplane
     */
    template <typename _Scalar, int _AmbientDim, int _Options>
    template <int OtherOptions>
