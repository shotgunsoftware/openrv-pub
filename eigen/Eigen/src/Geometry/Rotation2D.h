...
namespace Eigen
{
    ...
    public:
        ...
        /** Default constructor wihtout initialization. The represented rotation
         * is undefined. */
        ...
        /** \returns the spherical interpolation between \c *this and \a other
         * using parameter \a t. It is in fact equivalent to a linear
         * interpolation.
         */
