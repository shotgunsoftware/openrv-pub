...
namespace Eigen
{
     ...
     * "2" represents the z axis and "0" the x axis, etc. The returned angles
     * are such that we have the following equality:
     * \code
    ...
    MatrixBase<Derived>::eulerAngles(Index a0, Index a1, Index a2) const
    {
        ...
        if (a0 == a2)
        {
            ...
            // With a=(0,1,0), we have i=0; j=1; k=2, and after computing the
            // first two angles, we can compute their respective rotation, and
            // apply its inverse to M. Since the result must be a rotation
            // around x, we have:
            //
