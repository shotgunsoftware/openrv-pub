...
namespace Eigen
{
    ...
    // scalar
    //      and fallback to cwise-unary evaluator using bind1st_op and
    //      bind2nd_op.
    ...
    namespace internal
    {
            ...
            public:
                ...
                EIGEN_STRONG_INLINE InnerIterator& operator++()
                {
                        ...
                        && (m_lhsIter.index() == m_rhsIter.index()))
                    {
                        ...
                        m_value =
                            m_functor(m_lhsIter.value(), m_rhsIter.value());
                        ++m_lhsIter;
                        ++m_rhsIter;
                    }
                    else if (m_lhsIter
        ...
        public:
            ...
            enum
            {
                ...
                Flags = (XprType::Flags & ~RowMajorBit)
                        | (int(Rhs::Flags) & RowMajorBit)
            };
        ...
        struct binary_evaluator<
            CwiseBinaryOp<scalar_product_op<T1, T2>, Lhs, Rhs>, IteratorBased,
            IteratorBased>
        ...
        template <typename T1, typename T2, typename Lhs, typename Rhs>
        struct binary_evaluator<
            CwiseBinaryOp<scalar_product_op<T1, T2>, Lhs, Rhs>, IndexBased,
            IteratorBased>
            : sparse_conjunction_evaluator<
                  CwiseBinaryOp<scalar_product_op<T1, T2>, Lhs, Rhs>>
        {
        ...
        template <typename T1, typename T2, typename Lhs, typename Rhs>
        struct binary_evaluator<
            CwiseBinaryOp<scalar_quotient_op<T1, T2>, Lhs, Rhs>, IteratorBased,
            IndexBased>
            : sparse_conjunction_evaluator<
        ...
        struct sparse_conjunction_evaluator<XprType, IteratorBased,
                                            IteratorBased>
        ...
        public:
            ...
            public:
                EIGEN_STRONG_INLINE
                InnerIterator(const sparse_conjunction_evaluator& aEval,
                              Index outer)
                    : m_lhsIter(aEval.m_lhsImpl, outer)
                    , m_rhsIter(aEval.m_rhsImpl, outer)
                    , m_functor(aEval.m_functor)
        ...
        public:
            class InnerIterator
            {
                ...
                {
                    IsRowMajor =
                        (int(RhsArg::Flags) & RowMajorBit) == RowMajorBit
                };
        ...
        public:
            class InnerIterator
            {
                ...
                {
                    IsRowMajor =
                        (int(LhsArg::Flags) & RowMajorBit) == RowMajorBit
                };
    ...
    {
        return CwiseBinaryOp<
            internal::scalar_sum_op<typename SparseDerived::Scalar,
                                    typename DenseDerived::Scalar>,
