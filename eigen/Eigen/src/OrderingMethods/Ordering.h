...
#include "Eigen_Colamd.h"
    ...
    namespace internal
    {
         ...
         * \param[out] symmat the symmetric pattern A^T+A from the input matrix
         * \a A.
    ...
    public:
        ...
        void operator()(const MatrixType& mat, PermutationType& perm)
        {
            ...
            SparseMatrix<typename MatrixType::Scalar, ColMajor, StorageIndex>
                symm;
     ...
     * ordering The matrix should be in column-major and \b compressed format
    ...
    public:
         ...
         * \warning The input sparse matrix \a mat must be in compressed mode
         * (see SparseMatrix::makeCompressed()).
         */
        template <typename MatrixType>
        void operator()(const MatrixType& mat, PermutationType& perm)
        {
            eigen_assert(mat.isCompressed()
                         && "COLAMDOrdering requires a sparse matrix in "
                            "compressed mode. Call .makeCompressed() before "
                            "passing it to COLAMDOrdering");
