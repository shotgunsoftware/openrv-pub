    ...
    namespace internal
    {
            ...
            GlobalLU_t& glu, Index& nextl_col, Index krow, Traits& traits)
        {
            ...
            if (kperm == emptyIdxLU)
            {
                ...
                panel_lsub(nextl_col++) =
                    StorageIndex(krow); // krow is indexed into A
                        ...
                        while (xdfs < maxdfs)
                        {
                            ...
                            if (chmark != jj)
                            {
                                ...
                                if (chperm == emptyIdxLU)
                                {
                                    ...
                                    traits.mem_expand(panel_lsub, nextl_col,
                                                      chmark);
                                }
                                else
                                {
         ...
         *    marker1[i] >= jcol, if i was visited by earlier columns in this
         * panel;
         *
         ...
         * \param[out] segrep Segment representative i.e first nonzero row of
         * each segment
            ...
            IndexVector& xplore, GlobalLU_t& glu)
        {
            ...
            for (StorageIndex jj = StorageIndex(jcol); jj < jcol + w; jj++)
            {
                ...
                for (typename MatrixType::InnerIterator it(A, jj); it; ++it)
                {
                    ...
                    dfs_kernel(jj, perm_r, nseg, panel_lsub, segrep, repfnz_col,
                               xprune, marker, parent, xplore, glu, nextl_col,
                               krow, traits);
