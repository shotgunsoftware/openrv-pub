...
namespace Eigen
{
    ...
    namespace internal
    {
        ...
        /**
         * \brief Performs a symbolic factorization on column jcol and decide
         * the supernode boundary
         *
         * A supernode representative is the last column of a supernode.
         * The nonzeros in U[*,j] are segments that end at supernodes
         * representatives. The routine returns a list of the supernodal
         ...
         * \param [in,out] nseg Number of segments in current U[*,j] - new
         * segments appended
         * \param lsub_col defines the rhs vector to start the dfs
         * \param [in,out] segrep Segment representatives - new segments
         * appended
         * \param repfnz  First nonzero location in each row
         * \param xprune
         * \param marker  marker[i] == jj, if i was visited during dfs of
         * current column jj;
         * \param parent
        ...
        Index SparseLUImpl<Scalar, StorageIndex>::column_dfs(
            const Index m, const Index jcol, IndexVector& perm_r,
            ...
            GlobalLU_t& glu)
        {
            ...
            column_dfs_traits<IndexVector, ScalarVector> traits(jcol, jsuper,
                                                                glu, *this);
                 ...
                 k++)
            {
                ...
                dfs_kernel(StorageIndex(jcol), perm_r, nseg, glu.lsub, segrep,
                           repfnz, xprune, marker2, parent, xplore, glu, nextl,
                           krow, traits);
            } // for each nonzero ...
            ...
            else
            {
                ...
                { // starts a new supernode
                    ...
                    { // >= 3 columns in nsuper
                        ...
                        for (StorageIndex ifrom = jm1ptr; ifrom < nextl;
                             ++ifrom, ++ito)
            ...
            xprune(jcol) =
                StorageIndex(nextl); // Intialize upper bound for pruning
