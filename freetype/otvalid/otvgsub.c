...
static void otv_SingleSubst_validate(FT_Bytes table, OTV_Validator valid)
{
    FT_Bytes p = table;
    FT_UInt SubstFormat;
...
static void otv_MultipleSubst_validate(FT_Bytes table, OTV_Validator valid)
{
    FT_Bytes p = table;
    FT_UInt SubstFormat;
...
static void otv_AlternateSubst_validate(FT_Bytes table, OTV_Validator valid)
{
    FT_Bytes p = table;
    FT_UInt SubstFormat;
...
static void otv_Ligature_validate(FT_Bytes table, OTV_Validator valid)
{
    FT_Bytes p = table;
...
static void otv_LigatureSubst_validate(FT_Bytes table, OTV_Validator valid)
{
    FT_Bytes p = table;
    FT_UInt SubstFormat;
...
static void otv_ContextSubst_validate(FT_Bytes table, OTV_Validator valid)
{
    FT_Bytes p = table;
    FT_UInt SubstFormat;
...
static void otv_ChainContextSubst_validate(FT_Bytes table, OTV_Validator valid)
{
    FT_Bytes p = table;
    FT_UInt SubstFormat;
    ...
    case 2:
        ...
        OTV_NEST3(ChainContextSubstFormat2, ChainSubClassSet,
                  ChainSubClassRule);
        OTV_RUN(table, valid);
        break;
...
static void otv_ExtensionSubst_validate(FT_Bytes table, OTV_Validator valid)
{
    FT_Bytes p = table;
    FT_UInt SubstFormat;
...
otv_GSUB_validate(FT_Bytes table, FT_UInt glyph_count, FT_Validator ftvalid)
{
    ...
    otv_LookupList_validate(table + LookupList, valid);
    otv_FeatureList_validate(table + FeatureList, table + LookupList, valid);
    otv_ScriptList_validate(table + ScriptList, table + FeatureList, valid);
