...
const FTC_CacheClassRec ftc_cmap_cache_class = {
    ftc_cmap_node_new,           ftc_cmap_node_weight, ftc_cmap_node_compare,
    ftc_cmap_node_remove_faceid, ftc_cmap_node_free,

    sizeof(FTC_CacheRec),        ftc_cache_init,       ftc_cache_done,
};
                     ...
                     FT_Int cmap_index, FT_UInt32 char_code)
{
    ...
    if (cmap_index >= 16)
    {
        ...
        case FTC_OLD_CMAP_BY_ENCODING:
        {
            ...
            error =
                FTC_Manager_LookupFace(cache->manager, desc->face_id, &face);
            if (error)
                return 0;
