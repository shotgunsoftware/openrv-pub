...
const FTC_IFamilyClassRec ftc_basic_image_family_class = {
    {
        ...
        ftc_basic_family_init, 0, /* FTC_MruNode_ResetFunc */
...
const FTC_GCacheClassRec ftc_basic_image_cache_class = {
    {ftc_inode_new, ftc_inode_weight, ftc_gnode_compare,
     ftc_basic_gnode_compare_faceid, ftc_inode_free,

     sizeof(FTC_GCacheRec), ftc_gcache_init, ftc_gcache_done},
...
/* monochrome bitmap */
#define ftc_old_image_mono \
    ftc_old_image_format_bitmap | ftc_old_image_flag_monochrome
...
FT_EXPORT(FT_Error)
FTC_Image_Cache_New(FTC_Manager manager, FTC_ImageCache* acache);

FT_EXPORT(FT_Error)
FTC_Image_Cache_Lookup(FTC_ImageCache icache, FTC_OldImage_Desc* desc,
                       FT_UInt gindex, FT_Glyph* aglyph);
                       ...
                       FT_UInt gindex, FT_Glyph* aglyph)
{
    ...
    return FTC_ImageCache_Lookup((FTC_ImageCache)icache, &type0, gindex, aglyph,
                                 NULL);
}
...
const FTC_GCacheClassRec ftc_basic_sbit_cache_class = {
    {ftc_snode_new, ftc_snode_weight, ftc_snode_compare,
     ftc_basic_gnode_compare_faceid, ftc_snode_free,
...
FT_EXPORT(FT_Error)
FTC_SBit_Cache_New(FTC_Manager manager, FTC_SBitCache* acache);

FT_EXPORT(FT_Error)
FTC_SBit_Cache_Lookup(FTC_SBitCache cache, FTC_OldImage_Desc* desc,
                      FT_UInt gindex, FTC_SBit* ansbit);
                      ...
                      FT_UInt gindex, FTC_SBit* ansbit)
{
    ...
    return FTC_SBitCache_Lookup((FTC_SBitCache)cache, &type0, gindex, ansbit,
                                NULL);
}
