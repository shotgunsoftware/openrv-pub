...
ftc_inode_weight(FTC_Node ftcinode, FTC_Cache ftccache)
{
    ...
    case FT_GLYPH_FORMAT_BITMAP:
    {
        ...
        size = bitg->bitmap.rows * ft_labs(bitg->bitmap.pitch) + sizeof(*bitg);
    }
    break;
    ...
    case FT_GLYPH_FORMAT_OUTLINE:
    {
        ...
        size = outg->outline.n_points * (sizeof(FT_Vector) + sizeof(FT_Byte))
               + outg->outline.n_contours * sizeof(FT_Short) + sizeof(*outg);
    }
    break;
