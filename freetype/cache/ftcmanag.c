...
const FTC_MruListClassRec ftc_size_list_class = {
    sizeof(FTC_SizeNodeRec), ftc_size_node_compare, ftc_size_node_init,
    ftc_size_node_reset, ftc_size_node_done};
...
FTC_Manager_LookupSize(FTC_Manager manager, FTC_Scaler scaler, FT_Size* asize)
{
    ...
    *asize = NULL;
    ...
    FTC_MRULIST_LOOKUP_CMP(&manager->sizes, scaler, ftc_size_node_compare, node,
                           error);
...
const FTC_MruListClassRec ftc_face_list_class = {
    ...
    ftc_face_node_compare, ftc_face_node_init, 0, /* FTC_MruNode_ResetFunc */
    ftc_face_node_done};
...
static void FTC_Manager_Check(FTC_Manager manager)
{
    ...
    if (first)
    {
        ...
        if (count != manager->num_nodes)
            FT_ERROR(("FTC_Manager_Check: invalid cache node count %d instead "
                      "of %d\n",
...
FTC_Manager_Lookup_Face(FTC_Manager manager, FTC_FaceID face_id, FT_Face* aface)
{
