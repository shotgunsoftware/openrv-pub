...
cff_cmap_encoding_done(CFF_CMapStd cmap) { cmap->gids = NULL; }
...
cff_sid_free_glyph_name(TT_Face face, const char* gname)
{
...
cff_cmap_unicode_init(PS_Unicodes unicodes)
{
    ...
    return psnames->unicodes_init(
        memory, unicodes, cff->num_glyphs,
        (PS_GetGlyphNameFunc)&cff_sid_to_glyph_name,
        (PS_FreeGlyphNameFunc)&cff_sid_free_glyph_name, (FT_Pointer)face);
}
