...
static long get_time(void) { return clock() * 10000L / CLOCKS_PER_SEC; }
...
#if 1
    XVEC(408.9111, 535.3164), XVEC(455.8887, 634.396), XVEC(-37.8765, 786.2207),
...
static FT_Vector dummy_vec_2[4] = {XVEC(100.0, 100.0), XVEC(100.0, 200.0),
                                   XVEC(200.0, 200.0), XVEC(200.0, 133.0)};
