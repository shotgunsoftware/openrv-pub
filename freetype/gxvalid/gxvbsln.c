...
static void gxv_bsln_parts_fmt0_validate(FT_Bytes tables, FT_Bytes limit,
                                         GXV_Validator valid)
{
    FT_Bytes p = tables;
...
static void gxv_bsln_parts_fmt1_validate(FT_Bytes tables, FT_Bytes limit,
                                         GXV_Validator valid)
{
    FT_Bytes p = tables;
    ...
    gxv_LookupTable_validate(p + 2 * GXV_BSLN_VALUE_COUNT, limit, valid);

    GXV_EXIT;
}

static void gxv_bsln_parts_fmt2_validate(FT_Bytes tables, FT_Bytes limit,
                                         GXV_Validator valid)
{
    FT_Bytes p = tables;
...
static void gxv_bsln_parts_fmt3_validate(FT_Bytes tables, FT_Bytes limit,
                                         GXV_Validator valid)
{
    FT_Bytes p = tables;
    ...
    valid->lookupval_func = gxv_bsln_LookupValue_validate;
    valid->lookupfmt4_trans = gxv_bsln_LookupFmt4_transit;
    gxv_LookupTable_validate(p + (2 + 2 * GXV_BSLN_VALUE_COUNT), limit, valid);
