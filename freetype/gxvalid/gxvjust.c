...
static void gxv_just_wdp_entry_validate(FT_Bytes table, FT_Bytes limit,
                                        GXV_Validator valid)
{
    FT_Bytes p = table;
    FT_ULong justClass;
...
static void gxv_just_wdc_entry_validate(FT_Bytes table, FT_Bytes limit,
                                        GXV_Validator valid)
{
    FT_Bytes p = table;
    FT_ULong count, i;
...
static void gxv_just_widthDeltaClusters_validate(FT_Bytes table, FT_Bytes limit,
                                                 GXV_Validator valid)
{
    FT_Bytes p = table;
...
static void gxv_just_actSubrecord_type0_validate(FT_Bytes table, FT_Bytes limit,
                                                 GXV_Validator valid)
{
    FT_Bytes p = table;
...
static void gxv_just_actSubrecord_type1_validate(FT_Bytes table, FT_Bytes limit,
                                                 GXV_Validator valid)
{
    FT_Bytes p = table;
    FT_UShort addGlyph;
...
static void gxv_just_actSubrecord_type2_validate(FT_Bytes table, FT_Bytes limit,
                                                 GXV_Validator valid)
{
    FT_Bytes p = table;
...
static void gxv_just_actSubrecord_type4_validate(FT_Bytes table, FT_Bytes limit,
                                                 GXV_Validator valid)
{
    FT_Bytes p = table;
...
static void gxv_just_actSubrecord_type5_validate(FT_Bytes table, FT_Bytes limit,
                                                 GXV_Validator valid)
{
    FT_Bytes p = table;
    FT_UShort flags;
...
static void gxv_just_actSubrecord_validate(FT_Bytes table, FT_Bytes limit,
                                           GXV_Validator valid)
{
    FT_Bytes p = table;
...
static void gxv_just_pcActionRecord_validate(FT_Bytes table, FT_Bytes limit,
                                             GXV_Validator valid)
{
    FT_Bytes p = table;
...
static void gxv_just_pcTable_LookupValue_entry_validate(
    FT_UShort glyph, GXV_LookupValueDesc value, GXV_Validator valid)
{
    FT_UNUSED(glyph);
...
static void gxv_just_pcLookupTable_validate(FT_Bytes table, FT_Bytes limit,
                                            GXV_Validator valid)
{
    FT_Bytes p = table;
...
static void gxv_just_postcompTable_validate(FT_Bytes table, FT_Bytes limit,
                                            GXV_Validator valid)
{
    FT_Bytes p = table;
...
static void gxv_just_classTable_entry_validate(
    FT_Byte state, FT_UShort flags, GXV_StateTable_GlyphOffsetDesc glyphOffset,
    FT_Bytes table, FT_Bytes limit, GXV_Validator valid)
{
    FT_UShort setMark;
...
static void gxv_just_justClassTable_validate(FT_Bytes table, FT_Bytes limit,
                                             GXV_Validator valid)
{
    FT_Bytes p = table;
    FT_UShort length;
 ...
 */
static void gxv_just_justData_validate(FT_Bytes table, FT_Bytes limit,
                                       GXV_Validator valid)
{
    /*
