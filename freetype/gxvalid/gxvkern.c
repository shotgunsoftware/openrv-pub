...
static void gxv_kern_subtable_fmt0_validate(FT_Bytes table, FT_Bytes limit,
                                            GXV_Validator valid)
{
...
static void gxv_kern_subtable_fmt1_validate(FT_Bytes table, FT_Bytes limit,
                                            GXV_Validator valid)
{
    FT_Bytes p = table;
                                                   ...
                                                   GXV_Validator valid)
{
    ...
    gxv_array_getlimits_ushort(p, p + (2 * nGlyphs),
                               ...
                               &(GXV_KERN_FMT2_DATA(offset_max[spec])), valid);
...
static void gxv_kern_subtable_fmt2_validate(FT_Bytes table, FT_Bytes limit,
                                            GXV_Validator valid)
{
    GXV_ODTECT(3, odtect);
...
static void gxv_kern_subtable_fmt3_validate(FT_Bytes table, FT_Bytes limit,
                                            GXV_Validator valid)
{
    FT_Bytes p = table + GXV_KERN_SUBTABLE_HEADER_SIZE;
                                                   ...
                                                   GXV_Validator valid)
{
    ...
    {
        if (gxv_kern_coverage_new_apple_validate(coverage, format, valid))
        {
    ...
    {
        if (gxv_kern_coverage_classic_apple_validate(coverage, format, valid))
        {
            result = KERN_DIALECT_APPLE;
            goto Exit;
        }
...
static void gxv_kern_subtable_validate(FT_Bytes table, FT_Bytes limit,
                                       GXV_Validator valid)
{
    FT_Bytes p = table;
...
static void gxv_kern_validate_generic(FT_Bytes table, FT_Face face,
