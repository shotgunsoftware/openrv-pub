...
static void gxv_trak_trackTable_validate(FT_Bytes table, FT_Bytes limit,
                                         FT_UShort nTracks, GXV_Validator valid)
{
    FT_Bytes p = table;
...
static void gxv_trak_trackData_validate(FT_Bytes table, FT_Bytes limit,
                                        GXV_Validator valid)
{
    FT_Bytes p = table;
    FT_UShort nTracks;
    ...
    gxv_odtect_add_range(p, valid->subtable_length, "trackTable", odtect);
