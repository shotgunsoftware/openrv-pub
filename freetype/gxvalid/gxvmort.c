...
gxv_mort_featurearray_validate(FT_Bytes table, FT_Bytes limit,
                               FT_UInt nFeatureFlags, GXV_Validator valid)
{
    FT_Bytes p = table;
    FT_UInt i;
...
static void gxv_mort_subtables_validate(FT_Bytes table, FT_Bytes limit,
...
static void gxv_mort_chain_validate(FT_Bytes table, FT_Bytes limit,
                                    GXV_Validator valid)
{
    FT_Bytes p = table;
