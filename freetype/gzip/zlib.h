...
#define Z_NULL 0 /* for initializing zalloc, zfree, opaque */
    ...
    */
    ...
    /*
      ...
      be at least 0.1% larger than avail_in plus 12 bytes.  If deflate does not
      return Z_STREAM_END, then it must be called again as described above.
      ...
      possible (for example avail_in or avail_out was zero).
    */
    ...
    */
    ...
    by a filter (or predictor), or Z_HUFFMAN_ONLY to force Huffman encoding only
    (no string match).  Filtered data consists mostly of small values with a
    ...
    */
    ...
    /*
       ...
       be put at the end of the dictionary, not at the front.
    ...
    */
    ...
    inflateInit is used instead. If a compressed stream with a larger window
    ...
    */
    ...
    /*
       ...
       updated crc. If buf is NULL, this function returns the required initial
    ...
    */
     ...
     */
    ZEXTERN(int)
    inflateInit2_ OF((z_streamp strm, int windowBits, const char* version,
                      int stream_size));
