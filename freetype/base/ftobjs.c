...
FT_Load_Glyph(FT_Face face, FT_UInt glyph_index, FT_Int32 load_flags)
{
    ...
    autohint = 0;
    if (hinter && (load_flags & FT_LOAD_NO_HINTING) == 0
                          ...
                          FT_Parameter* params, FT_Face* aface)
{
    ...
    error =
        clazz->init_face(stream, face, (FT_Int)face_index, num_params, params);
    if (error)
        goto Fail;
                     ...
                     FT_Matrix* p_transform)
{
    ...
    if (glyph != NULL && glyph->format == FT_GLYPH_FORMAT_COMPOSITE
