...
FT_CALLBACK_TABLE_DEF const FT_CMap_ClassRec t1_cmap_standard_class_rec = {
    ...
    (FT_CMap_InitFunc)t1_cmap_standard_init, (FT_CMap_DoneFunc)t1_cmap_std_done,
...
FT_CALLBACK_TABLE_DEF const FT_CMap_ClassRec t1_cmap_expert_class_rec = {
    ...
    (FT_CMap_InitFunc)t1_cmap_expert_init, (FT_CMap_DoneFunc)t1_cmap_std_done,
    (FT_CMap_CharIndexFunc)t1_cmap_std_char_index,
    (FT_CMap_CharNextFunc)t1_cmap_std_char_next};
...
t1_cmap_unicode_init(PS_Unicodes unicodes)
{
    ...
    return psnames->unicodes_init(memory, unicodes, face->type1.num_glyphs,
