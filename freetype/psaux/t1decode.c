...
#define close_contour t1_builder_close_contour
    ...
    while (ip < limit)
    {
        ...
        case 255: /* four bytes integer */
            ...
            value = (FT_Int32)(((FT_Long)ip[0] << 24) | ((FT_Long)ip[1] << 16)
                               | ((FT_Long)ip[2] << 8) | ip[3]);
            ip += 4;
            break;
        ...
        else if (op == op_callothersubr) /* callothersubr */
        {
            ...
            case 19:
                ...
                /*    of BuildCharArray with WeightVector               */
                {
                    ...
                    if (idx < 0
                        || idx + blend->num_designs
                               > decoder->face->len_buildchar)
                        goto Unexpected_OtherSubr;

                    memcpy(&decoder->buildchar[idx], blend->weight_vector,
                           blend->num_designs
        ...
        else /* general operator */
        {
            ...
            case op_return:
                ...
                {
                    FT_ERROR(
                        ("t1_decoder_parse_charstrings: unexpected return\n"));
                    goto Syntax_Error;
                }
