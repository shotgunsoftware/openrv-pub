...
tt_face_load_directory_stub(TT_Face face, FT_Stream stream, SFNT_Header header)
{
    FT_UNUSED(face);
    FT_UNUSED(stream);
    FT_UNUSED(header);
...
tt_face_free_hdmx_stub(TT_Face face) { FT_UNUSED(face); }
...
static const SFNT_Interface sfnt_interface = {
...
#ifdef FT_CONFIG_OPTION_OLD_INTERNALS
    tt_face_load_sfnt_header_stub, tt_face_load_directory_stub,
#endif
...
#ifdef FT_CONFIG_OPTION_OLD_INTERNALS
    tt_face_load_hdmx_stub, tt_face_free_hdmx_stub,
#endif
...
#ifdef FT_CONFIG_OPTION_OLD_INTERNALS
    tt_face_set_sbit_strike_stub, tt_face_load_sbit_stub,

    tt_find_sbit_image, tt_load_sbit_metrics,
#endif
...
#ifdef TT_CONFIG_OPTION_POSTSCRIPT_NAMES
    /* see `ttpost.h' */
    tt_face_get_ps_name, tt_face_free_ps_names,
#else
    0, 0,
#endif

#ifdef FT_CONFIG_OPTION_OLD_INTERNALS
    tt_face_load_charmap_stub, tt_face_free_charmap_stub,
#endif
    ...
    tt_face_load_eblc, tt_face_free_eblc,
