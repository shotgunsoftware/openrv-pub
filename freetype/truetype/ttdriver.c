                           ...
                           FT_UInt glyph_index, FT_Int32 load_flags)
{
    ...
    {
        load_flags |= FT_LOAD_NO_HINTING | FT_LOAD_NO_BITMAP | FT_LOAD_NO_SCALE;
    }
...
static const FT_Service_MultiMastersRec tt_service_gx_multi_masters = {
    (FT_Get_MM_Func)NULL, (FT_Set_MM_Design_Func)NULL,
    (FT_Set_MM_Blend_Func)TT_Set_MM_Blend, (FT_Get_MM_Var_Func)TT_Get_MM_Var,
