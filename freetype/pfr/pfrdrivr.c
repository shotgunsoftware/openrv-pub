                ...
                FT_Fixed* ametrics_x_scale, FT_Fixed* ametrics_y_scale)
{
    ...
    {
        x_scale =
            FT_DivFix(size->metrics.x_ppem << 6, phys->metrics_resolution);

        y_scale =
            FT_DivFix(size->metrics.y_ppem << 6, phys->metrics_resolution);
    }
...
const FT_Service_PfrMetricsRec pfr_metrics_service_rec = {
    pfr_get_metrics, pfr_face_get_kerning, pfr_get_advance};
