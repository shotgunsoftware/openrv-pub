...
static int yaml_emitter_emit_node(yaml_emitter_t* emitter, yaml_event_t* event,
...
static int yaml_emitter_check_simple_key(yaml_emitter_t* emitter)
{
    ...
    case YAML_SCALAR_EVENT:
        if (emitter->scalar_data.multiline)
            return 0;
        length +=
            emitter->anchor_data.anchor_length + emitter->tag_data.handle_length
                                      ...
                                      yaml_event_t* event)
{
    ...
    case YAML_SCALAR_EVENT:
        ...
        {
            if (!yaml_emitter_analyze_anchor(emitter, event->data.scalar.anchor,
                                             0))
                return 0;
        }
