...
test_case utf8_sequences[] = {
    ...
    {"a simple test",
     "'test' is "
     "'\xd0\xbf\xd1\x80\xd0\xbe\xd0\xb2\xd0\xb5\xd1\x80\xd0\xba\xd0\xb0' in "
     "Russian!",
     1},
    {"an empty line", "!", 1},
    ...
    {"8 first bytes of 4-byte sequences {0xf0-0xf7}",
     "\xf0 |\xf1 |\xf2 |\xf3 |\xf4 |\xf5 |\xf6 |\xf7 !", 0},
    ...
    {"overlong sequences {u-2f}",
     "\xc0\xaf|\xe0\x80\xaf|\xf0\x80\x80\xaf|\xf8\x80\x80\x80\xaf|"
     "\xfc\x80\x80\x80\x80\xaf!",
     0},

    {"maximum overlong sequences",
     "\xc1\xbf|\xe0\x9f\xbf|\xf0\x8f\xbf\xbf|\xf8\x87\xbf\xbf\xbf|"
    ...
    {"single UTF-16 surrogates",
     "\xed\xa0\x80|\xed\xad\xbf|\xed\xae\x80|\xed\xaf\xbf|\xed\xb0\x80|"
     "\xed\xbe\x80|\xed\xbf\xbf!",
     0},

    {"paired UTF-16 surrogates",
     "\xed\xa0\x80\xed\xb0\x80|\xed\xa0\x80\xed\xbf\xbf|"
     "\xed\xad\xbf\xed\xb0\x80|"
     "\xed\xad\xbf\xed\xbf\xbf|\xed\xae\x80\xed\xb0\x80|"
...
test_case boms[] = {
    ...
    {"no bom (utf-8)",
     "Hi is \xd0\x9f\xd1\x80\xd0\xb8\xd0\xb2\xd0\xb5\xd1\x82!", 13},
    {"bom (utf-8)",
     "\xef\xbb\xbfHi is \xd0\x9f\xd1\x80\xd0\xb8\xd0\xb2\xd0\xb5\xd1\x82!", 13},
    {"bom (utf-16-le)",
...
int check_utf8_sequences(void)
{
    ...
    for (k = 0; utf8_sequences[k].test; k++)
    {
        ...
        while (1)
        {
            ...
            yaml_parser_set_input_string(&parser, (unsigned char*)start,
                                         end - start);
...
int check_boms(void)
{
    ...
    for (k = 0; boms[k].test; k++)
    {
        ...
        else
        {
            ...
            {
                printf("- (value '%s' does not equal to the original value "
                       "'%s')\n",
