...
extern "C"
{
    ...
    GC_API void GC_CALL GC_init_gcj_malloc(
        int /* mp_index */, void* /* really mark_proc */ /* mp */);
    ...
    GC_gcj_malloc(size_t /* lb */,
                  void* /* ptr_to_struct_containing_descr */) GC_ATTR_MALLOC
        GC_ATTR_ALLOC_SIZE(1);
    /* The debug versions allocate such that the specified mark_proc        */
    /* is always invoked.                                                   */
    GC_API void* GC_CALL GC_debug_gcj_malloc(
        size_t /* lb */, void* /* ptr_to_struct_containing_descr */,
        GC_EXTRA_PARAMS) GC_ATTR_MALLOC GC_ATTR_ALLOC_SIZE(1);

    /* Similar to GC_gcj_malloc, but assumes that a pointer to near the     */
    /* beginning of the resulting object is always maintained.              */
    GC_API void* GC_CALL GC_gcj_malloc_ignore_off_page(
        size_t /* lb */,
        void* /* ptr_to_struct_containing_descr */) GC_ATTR_MALLOC
        GC_ATTR_ALLOC_SIZE(1);
