...
#define PUSH_CONTENTS_HDR(current, mark_stack_top, mark_stack_limit, source,   \
                          exit_label, hhdr, do_offset_check)                   \
    {                                                                          \
        size_t displ =                                                         \
...
#define PUSH_CONTENTS_HDR(current, mark_stack_top, mark_stack_limit, source,  \
    ...
    {                                                                         \
        ...
        {                                                                     \
        FIXME:                                                                \
            fails if offset is a multiple of HBLKSIZE which                   \
                becomes 0 if (inv_sz == LARGE_INV_SZ)                         \
            {                                                                 \
                size_t obj_displ;                                             \
                base = (ptr_t)(hhdr->hb_block);                               \
                obj_displ = (ptr_t)(current) - base;                          \
...
#define GC_PUSH_ONE_HEAP(p, source)                                  \
    ...
    {                                                                \
        GC_mark_stack_top =                                          \
            GC_mark_and_push((void*)(p), GC_mark_stack_top,          \
