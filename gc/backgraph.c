...
/* #include <unistd.h> */
    ...
    || (ALIGNMENT != CPP_WORDSZ / 8) /* || !defined(UNIX_LIKE) */
...
static back_edges* new_back_edges(void)
{
    ...
    {
        back_edge_space =
            (back_edges*)GET_MEM(MAX_BACK_EDGE_STRUCTS * sizeof(back_edges));
...
#define FOR_EACH_PRED(q, p, s)                                             \
    {                                                                      \
        ...
        {                                                                  \
            ...
            for (total_ = 0, local_ = 0; total_ < n_edges_;                \
                 ++local_, ++total_)                                       \
            {                                                              \
                if (local_ == MAX_IN)                                      \
                {                                                          \
