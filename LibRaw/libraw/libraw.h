...
class DllDef LibRaw
{
  ...
  int  get_no_of_threads() { return _nthreads; }
  void set_no_of_threads(int n) { _nthreads = n; }
...
protected:
    ...
    void static ahd_interpolate_thread_func (DCRAWThreadData *td);
