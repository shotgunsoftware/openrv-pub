...
// The example parses from the character string (above):
        ...
        if (!loadOkay)
        {
            printf("Could not load test file 'demotest.xml'. Error='%s'. "
                   "Exiting.\n",
                   doc.ErrorDesc());
            exit(1);
        }
        ...
        node =
            todoElement->FirstChildElement(); // This skips the "PDA" comment.
        assert(node);
        ...
        {
            cout << "\n** Parsing. **\n";
            istringstream parse0("<Element0 attribute0='foo0' attribute1= "
                                 "noquotes attribute2 = '&gt;' />");
...
#ifdef TIXML_USE_STL
        {
            ...
            // Round trip check: stream in, then stream back out to verify. The
            // stream out has already been checked, above. We use the output
    ...
    printf("\n** UTF-8 **\n");
    {
        ...
        else
        {
            ...
            // Get the attribute "value" from the "Russian" element and check
            // it.
    ...
    {
        TiXmlDocument doc("midsummerNightsDreamWithAVeryLongFilenameToConfuseTh"
                          "eStringHandlingRoutines.xml");
        bool loadOkay = doc.LoadFile();
...

    {
        ...
        const char* expected =
            "Line 5 has \"quotation marks\" and 'apostrophe marks'. It also "
            "has <, >, and &, as well as a fake copyright \xC2\xA9.";
...

    {
        ...
        const char* doctype2 = "<element> This has leading, trailing, and  "
    ...
    {
        // trying to repro ]1874301]. If it doesn't go into an infinite loop,
        // all is well.
        unsigned char buf[] =
...

    {
        ...
        /* Could not repro. {
                ...
                //XmlTest( "Odd XML parsing.", xml.FirstChildElement()->Value(),
        "XML" ); TiXmlPrinter printer; xml.Accept( &printer ); fprintf( stdout,
        "%s", printer.CStr() );
        }*/
    }
