// mR - modified from http://www.opensource.apple.com/darwinsource/DevToolsJun2003/rsync-8/rsync/lib/fnmatch.c
...
#if 1	/* header files included better by ../rsync.h */
