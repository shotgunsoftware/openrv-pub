...
#error ERROR [__FILE__, line __LINE__]: Cleanup type undefined.
    ...
    PTW32_DLLPORT int PTW32_CDECL pthread_barrierattr_getpshared(
    ...
    PTW32_DLLPORT int PTW32_CDECL pthread_mutex_timedlock(
    ...
    PTW32_DLLPORT int PTW32_CDECL pthread_getschedparam(
     ...
     */
    PTW32_DLLPORT int PTW32_CDECL pthread_rwlock_init(
...
#define gmtime_r(_clock, _result) \
    (gmtime((_clock)) ? (*(_result) = *gmtime((_clock)), (_result)) : (0))

#define localtime_r(_clock, _result) \
    (localtime((_clock)) ? (*(_result) = *localtime((_clock)), (_result)) : (0))
