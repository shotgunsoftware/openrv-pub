 ...
 */
{
    if (ptw32_processInitialized)
    {
         ...
         * library. Such programs must call ptw32_processInitialize()
         * explicitly, since this initialization routine is automatically called
         * only when the dll is loaded.
         */
        return PTW32_TRUE;
    }
