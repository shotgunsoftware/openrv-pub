  ...
  /*
    ...
    */
       ...
       HANDLE e = (HANDLE)  InterlockedCompareExchange64((LONGLONG*) flag,
                                       ...
                                       (LONGLONG) 0);
#else
       HANDLE e = (HANDLE) InterlockedCompareExchange((LPLONG) flag,
                                      (LONG) -1,
                                      (LONG) 0);
#endif
  if ((HANDLE)0 != e)
...
{
#ifdef _WIN64
  if (0 == InterlockedExchangeAdd64((LONGLONG *)flag, (LONGLONG) 0)) /* MBR fence */
#else
  if (0 == InterlockedExchangeAdd((LPLONG)flag, 0)) /* MBR fence */
#endif
    {
       ...
       */
#ifdef _WIN64
       if (0 ==  InterlockedCompareExchange64((LONGLONG*) flag,
                                       (LONGLONG) e,
                                       (LONGLONG) 0))
#else
       if (0 == InterlockedCompareExchange((LPLONG) flag,
                                      (LONG) e,
                                      (LONG) 0))
#endif
	{
...
ptw32_mcs_lock_acquire (ptw32_mcs_lock_t * lock, ptw32_mcs_local_node_t * node)
{
  ...
  */
  ...
  pred = (ptw32_mcs_local_node_t *)InterlockedExchange64((LONGLONG*)lock,
						              (LONGLONG)node);
#else
  pred = (ptw32_mcs_local_node_t *)InterlockedExchange((LPLONG)lock,
						              (LONG)node);
#endif
...
#ifdef _WIN64
    InterlockedExchangeAdd64((LONGLONG*)&node->next, (LONGLONG) 0); /* MBR fence */
#else
  ...
  if (0 == next)
    {
	  ...
	  PTW32_INTERLOCKED_COMPARE_EXCHANGE((PTW32_INTERLOCKED_LPLONG)lock,
					     ...
					     (PTW32_INTERLOCKED_LONG)node))
                                             */
#ifdef _WIN64
          InterlockedCompareExchange64((LONGLONG*) lock,
                                       (LONGLONG) 0,
                                       (LONGLONG) node)
#else
          InterlockedCompareExchange((LPLONG) lock,
                                      (LONG) 0,
                                      (LONG) node)
#endif
          )
