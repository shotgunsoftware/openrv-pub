...
extern "C"
{
	...
	return THREADCACHEMAX;
        ...
        if (mem)
        {
            ...
            assert(cinuse(
                p)); /* If this fails, someone tried to free a block twice */
            if (cinuse(p))
    ...
    struct threadcacheblk_t
    { /* Keep less than 16 bytes on 32 bit systems and 32 bytes on 64 bit
         systems */
    ...
    { /* 8=1000	16=10000	20=10100	24=11000	32=100000
         48=110000	4096=1000000000000 */
        unsigned int topbit, size = (unsigned int)(_size >> 4);
        /* 16=1		20=1	24=1	32=10	48=11	64=100	96=110	128=1000
         * 4096=100000000 */
    ...
    static NOINLINE int InitPool(nedpool* p, size_t capacity,
    ...
    { /* threads is -1 for system pool */
        ...
        if (!(p->m[0] = (mstate)create_mspace(capacity, 1)))
            goto err;
        p->m[0]->extp = p;
        // p->threads=(threads<1 || threads>MAXTHREADSINPOOL) ? MAXTHREADSINPOOL
        // : threads;
