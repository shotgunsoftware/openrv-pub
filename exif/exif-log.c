...
static struct
{
    ...
    const char* title;
    const char* message;
} codes[] = {{EXIF_LOG_CODE_DEBUG, N_("Debugging information"),
...
void exif_logv(ExifLog* log, ExifLogCode code, const char* domain,
