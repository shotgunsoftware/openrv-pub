...
#define ESL_MMMN                                                 \
    {EXIF_SUPPORT_LEVEL_MANDATORY, EXIF_SUPPORT_LEVEL_MANDATORY, \
     EXIF_SUPPORT_LEVEL_MANDATORY, EXIF_SUPPORT_LEVEL_NOT_RECORDED}
#define ESL_MMMM                                                 \
    {EXIF_SUPPORT_LEVEL_MANDATORY, EXIF_SUPPORT_LEVEL_MANDATORY, \
     EXIF_SUPPORT_LEVEL_MANDATORY, EXIF_SUPPORT_LEVEL_MANDATORY}
#define ESL_OMON                                                \
    {EXIF_SUPPORT_LEVEL_OPTIONAL, EXIF_SUPPORT_LEVEL_MANDATORY, \
     EXIF_SUPPORT_LEVEL_OPTIONAL, EXIF_SUPPORT_LEVEL_NOT_RECORDED}
#define ESL_NNOO                                                       \
    {EXIF_SUPPORT_LEVEL_NOT_RECORDED, EXIF_SUPPORT_LEVEL_NOT_RECORDED, \
     EXIF_SUPPORT_LEVEL_OPTIONAL, EXIF_SUPPORT_LEVEL_OPTIONAL}
#define ESL_NNMN                                                       \
...
#define ESL_NNNM                                                       \
    {EXIF_SUPPORT_LEVEL_NOT_RECORDED, EXIF_SUPPORT_LEVEL_NOT_RECORDED, \
     EXIF_SUPPORT_LEVEL_NOT_RECORDED, EXIF_SUPPORT_LEVEL_MANDATORY}
#define ESL_NNNO                                                       \
    {EXIF_SUPPORT_LEVEL_NOT_RECORDED, EXIF_SUPPORT_LEVEL_NOT_RECORDED, \
     EXIF_SUPPORT_LEVEL_NOT_RECORDED, EXIF_SUPPORT_LEVEL_OPTIONAL}
...
static struct
{
    ...
    {EXIF_TAG_NEW_SUBFILE_TYPE, "NewSubfileType", "New Subfile Type",
     N_("A general indication of the kind of data "
    ...
    {EXIF_TAG_SUB_IFDS, "SubIFDs", "SubIFD Offsets",
     N_("Defined by Adobe Corporation "
    ...
    {EXIF_TAG_RELATED_IMAGE_WIDTH, "RelatedImageWidth", "RelatedImageWidth",
     ""},
    {EXIF_TAG_RELATED_IMAGE_LENGTH, "RelatedImageLength", "RelatedImageLength",
     ""},
    {EXIF_TAG_CFA_REPEAT_PATTERN_DIM, "CFARepeatPatternDim",
     "CFARepeatPatternDim", ""},
    {EXIF_TAG_CFA_PATTERN, "CFAPattern", N_("CFA Pattern"),
    ...
    {EXIF_TAG_INTER_COLOR_PROFILE, "InterColorProfile", "InterColorProfile",
     ""},
    ...
    {EXIF_TAG_FOCAL_PLANE_RESOLUTION_UNIT, "FocalPlaneResolutionUnit",
     ...
     N_("Indicates the unit for measuring <FocalPlaneXResolution> and "
        ...
        "<ResolutionUnit>.")},
    {EXIF_TAG_SUBJECT_LOCATION, "SubjectLocation", N_("Subject Location"),
    ...
    {EXIF_TAG_NEW_CFA_PATTERN, "CFAPattern", N_("CFA Pattern"),
     N_("Indicates the color filter array (CFA) geometric pattern of the "
        "image sensor when a one-chip color area sensor is used. "
        "It does not apply to all sensing methods.")},
    ...
    {EXIF_TAG_WHITE_BALANCE, "WhiteBalance", N_("White Balance"),
     N_("This tag indicates the white balance mode set when the image "
        "was shot.")},
    {EXIF_TAG_DIGITAL_ZOOM_RATIO, "DigitalZoomRatio", N_("Digital Zoom Ratio"),
    ...
    {EXIF_TAG_FOCAL_LENGTH_IN_35MM_FILM, "FocalLengthIn35mmFilm",
     ...
     N_("This tag indicates the equivalent focal length assuming a "
        ...
        "FocalLength tag.")},
    {EXIF_TAG_SCENE_CAPTURE_TYPE, "SceneCaptureType", N_("Scene Capture Type"),
...
#define RECORDED                                                      \
    ((ExifTagTable[i].esl[ifd][EXIF_DATA_TYPE_UNCOMPRESSED_CHUNKY]    \
      != EXIF_SUPPORT_LEVEL_NOT_RECORDED)                             \
     || (ExifTagTable[i].esl[ifd][EXIF_DATA_TYPE_UNCOMPRESSED_PLANAR] \
         != EXIF_SUPPORT_LEVEL_NOT_RECORDED)                          \
     || (ExifTagTable[i].esl[ifd][EXIF_DATA_TYPE_UNCOMPRESSED_YCC]    \
         != EXIF_SUPPORT_LEVEL_NOT_RECORDED)                          \
     || (ExifTagTable[i].esl[ifd][EXIF_DATA_TYPE_COMPRESSED]          \
         != EXIF_SUPPORT_LEVEL_NOT_RECORDED))
...
{
    const static ExifIfd ifds[5] = {EXIF_IFD_0, EXIF_IFD_1, EXIF_IFD_EXIF,
                                    EXIF_IFD_INTEROPERABILITY, EXIF_IFD_GPS};
    int i;
    for (i = 0; i < 5; i++)
    {
