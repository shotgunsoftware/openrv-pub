...
static struct
{
    ...
    {MNOTE_NIKON_TAG_WHITEBALANCEFINE, "WHITEBALANCEFINE",
     N_("Whitebalance fine ajustment"), ""},
    ...
    {MNOTE_NIKON_TAG_FLASHEXPCOMPENSATION, "FLASHEXPCOMPENSATION",
    ...
    {MNOTE_NIKON_TAG_AFFOCUSPOSITION, "AFFOCUSPOSITION",
     N_("AF Focus position"), ""},
    ...
    {MNOTE_NIKON_TAG_SENSORPIXELSIZE, "SENSORPIXELSIZE",
    ...
    {MNOTE_NIKON_TAG_IMAGE_DATASIZE, "IMAGEDATASIZE", N_("Image datasize"),
     N_("Size of compressed image data in bytes.")},
    {MNOTE_NIKON_TAG_UNKNOWN_0X00A3, NULL, NULL, NULL},
    {MNOTE_NIKON_TAG_TOTALPICTURES, "TOTALPICTURES,",
     N_("Total number of pictures taken"), ""},
    ...
    {MNOTE_NIKON_TAG_CAPTUREEDITORDATA, "CAPTUREEDITORDATA",
     N_("Capture Editor Data"), ""},
    {MNOTE_NIKON_TAG_CAPTUREEDITORVER, "CAPTUREEDITORVER",
     N_("Capture Editor Version"), ""},
    ...
    {MNOTE_NIKON1_TAG_IMAGEADJUSTMENT, "ImageAdjustment",
     N_("Image Adjustment"), ""},
    ...
    {MNOTE_OLYMPUS_TAG_FOCUSDIST, "ManualFocusDistance",
     N_("Manual Focus Distance"), ""},
