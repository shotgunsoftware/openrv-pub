...
#include <libexif/exif-mem.h>
    ...
    EXIF_EXPORT ExifEntry* exif_entry_new(void);

    EXIF_EXPORT ExifEntry* exif_entry_new_mem(ExifMem*);

    /*! Increase reference counter for #ExifEntry* */
    EXIF_EXPORT void exif_entry_ref(ExifEntry* entry);

    /*! Decrease reference counter for #ExifEntry* */
    EXIF_EXPORT void exif_entry_unref(ExifEntry* entry);
     ...
     */
    EXIF_EXPORT void exif_entry_free(ExifEntry* entry);

    EXIF_EXPORT void exif_entry_initialize(ExifEntry* entry, ExifTag tag);
    EXIF_EXPORT void exif_entry_fix(ExifEntry* entry);
     ...
     */
    EXIF_EXPORT const char* exif_entry_get_value(ExifEntry* entry, char* val,
                                                 unsigned int maxlen);

    /*! Dump text representation of #ExifEntry to stdout */
    EXIF_EXPORT void exif_entry_dump(ExifEntry* entry, unsigned int indent);

#define exif_entry_get_ifd(e) \
    ((e) ? exif_content_get_ifd((e)->parent) : EXIF_IFD_COUNT)
