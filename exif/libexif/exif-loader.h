 ...
 */
EXIF_EXPORT void        exif_loader_write_file (ExifLoader *loader, const char *fname);
 ...
 */
EXIF_EXPORT unsigned char exif_loader_write (ExifLoader *loader, unsigned char *buf, unsigned int sz);
