...
EXIF_EXPORT const char *mnote_olympus_tag_get_name        (MnoteOlympusTag tag);
EXIF_EXPORT const char *mnote_olympus_tag_get_title       (MnoteOlympusTag tag);
EXIF_EXPORT const char *mnote_olympus_tag_get_description (MnoteOlympusTag tag);
